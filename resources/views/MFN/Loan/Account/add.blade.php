                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 form-group">
                                        <label class="input-title RequiredStar">Member</label>
                                        <div class="input-group">
                                            <select class="form-control" name="memberId" id="memberId" required
                                                data-error="Please Select Member Name">
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control round"
                                                id="disbursementDate" name="disbursementDate" placeholder="DD-MM-YYYY">
                                            @else
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            <select class="form-control clsSelect2" name="productId" id="productId"
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            <input name="loanApplicationNo" type="text"
                                                class="form-control round textNumber"
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            @if ($isOpening)
                                            <input type="text" class="form-control round"
                                                id="firstRepayDate" name="firstRepayDate" placeholder="DD-MM-YYYY"
                                                autocomplete="off" required data-error="Please Select Date">
                                            @else
                                            <input type="text" class="form-control round" id="firstRepayDate"
                                                name="firstRepayDate" placeholder="DD-MM-YYYY" readonly
                                                autocomplete="off">
                                            @endif
                                ...
                                <div class="row">
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control round textNumber" name="loanCycle"
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control round textAmount" name="loanAmount"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control round textNumber" name="folioNumber"
                                                id="folioNumber" placeholder="Enter Folio Number">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control round" name="interestCalMethod"
                                                id="interestCalMethod" readonly required
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control round" name="interestRate"
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control round" name="additionalFee"
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control round" name="loanFormFee"
                                                id="loanFormFee" readonly placeholder="{{$loanFormFeeLabel}}">
                                        </div>
                                    </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            <textarea name="note" id="note" rows="3" class="form-control round"
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control round textNumber" name="openingCollectionAmountPrincipal"
                                                id="openingCollectionAmountPrincipal" placeholder="Enter Collection Amount">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control round textNumber" name="openingCollectionAmountInterest"
                                                id="openingCollectionAmountInterest" placeholder="Enter Collection Amount">
                                        </div>
                                    </div>
                                    @else
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control round textNumber" name="openingCollectionAmount"
                                                id="openingCollectionAmount" placeholder="Enter Collection Amount">
                                        </div>
                                    </div>
                                    @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control textNumber round mobileNo"
                                                name="guarantorPhones[]" @if(!$isOpening) required @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control textNumber round mobileNo"
                                                name="guarantorPhones[]" placeholder="Enter Guarantor Contact No.">
                                        </div>
                                        <div class="help-block with-errors is-invalid"></div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="familyFTM"
                                                        class="form-control round textNumber"
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="familyFTF"
                                                        class="form-control round textNumber"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="familyPTM"
                                                        class="form-control round textNumber"
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="familyPTF"
                                                        class="form-control round textNumber"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="businessName" class="form-control round"
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <textarea name="businessLocation" rows="2"
                                                        ...
                                                        placeholder="Enter Business Location"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <label class="input-title">Full Time Male</label>
                                                <div class="input-group">
                                                    <input type="text" name="outsideFTM"
                                                        class="form-control textNumber round"
                                            ...
                                            <div class="col-lg-6">
                                                <label class="input-title">Full Time Female</label>
                                                <div class="input-group">
                                                    <input type="text" name="outsideFTF"
                                                        class="form-control textNumber round"
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="partTimeMaleWage"
                                                        class="form-control textNumber round"
                                                        placeholder="Part Time Male Wage">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="partTimeFemaleWage"
                                                        class="form-control textNumber round"
                                                        placeholder="Part Time Female Wage">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input class="profileImage mt-2"
                                                            name="firstGuarantorProfileImage"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                @endif
                                                                <input type="text"
                                                                    name="firstGuarantorSignatureImageText"
                                                ...
                                                <div class="well border-bottom">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div style="width: 290px; height: 190px;">
                                                                <div></div>
                                                                <video id="secondGuarantorProfileVideo"
                                                                    autoplay="autoplay"
                                                                    style="width: 290px; height: 190px;"></video>
                                                            </div>
                                                            <br>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="">
                                                                    ...
                                                                    @endif
                                                                    <input type="text"
                                                                        name="secondGuarantorProfileImageText"
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            id="secondGuarantorSignatureImageText"
                                                                            hidden>
...
<script type="text/javascript">
    ...
    var maxLoanAmount = 0;
    var minLoanAmount = 0;
    var isInsuranceApplicable = 0;
    var insuranceCalculationMethodId = 0;
    var insurancePercentage = 0;
    var fixedInsuranceAmount = 0;
    ...
    $(document).ready(function () {        
        ...
        /* get informations on selecting member */
        $("#memberId").change(function (e) {
            $("#productId option:gt(0)").remove();

            var memberId = $(this).val();
            var disbursementDate = $("#disbursementDate").val();

            if (memberId == '' || disbursementDate == '') {
                return false;
            }
            ...
            $.ajax({
                ...
                success: function (response) {
                    $.each(response['loanProducts'], function (index, obj) {
                        $("#productId").append("<option value=" + obj.id + ">" + obj
                            .name + "</option>");
                    });

                    $("#loanCycle").val(response['loanCycle']);

                    // set member image source if not empty
                    if (response['profileImage'] != '') {
                        $("#profileImagePreview").attr("src", response['profileImage']);
                    }
                    if (response['signatureImage'] != '') {
                        $("#signatureImagePreview").attr("src", response['signatureImage']);
                    }
                },
                error: function () {
                    alert('error!');
        ...
        /* end get informations on selecting member */
        $("#disbursementDate").on('change', function () {
            $("#memberId").trigger('change');
        });

        /* get informations on selecting product */
        $("#productId").change(function (e) {
            $("#loanCode").val('');
            $("#repaymentFrequencyId option:gt(0)").remove();
            $("#numberOfInstallment option:gt(0)").remove();
            $("#loanDurationInMonth option:gt(0)").remove();

            maxLoanAmount = 0;
            minLoanAmount = 0;
            isInsuranceApplicable = 0;
            insuranceCalculationMethodId = 0;
            insurancePercentage = 0;
            fixedInsuranceAmount = 0;

            $('#loanAmount').val(0).trigger('input');
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if ('repaymentFrequencies' in response['repaymentInfos']) {
                        $.each(response['repaymentInfos']['repaymentFrequencies'],
                            function (
                                index, value) {
                                $("#repaymentFrequencyId").append(
                                    "<option installments=" +
                                    response['repaymentInfos'][
                                        'eligibleNumberOfInstallments'
                                    ][index] + " value=" +
                                    index + ">" + value + "</option>");
                            });
                    }

                    if ('eligibleMonths' in response['repaymentInfos']) {
                        $.each(response['repaymentInfos']['eligibleMonths'],
                            function (
                                index, value) {
                                $("#loanDurationInMonth").append(
                                    "<option value=" +
                                    value + ">" + value + "</option>");
                            });
                    }
                    ...
                    $("#loanFormFee").val(response['product'].formFee);

                    maxLoanAmount = response['product'].maxLoanAmount;
                    minLoanAmount = response['product'].minLoanAmount;
                    isInsuranceApplicable = response['product'].isInsuranceApplicable;
                    insuranceCalculationMethodId = response['product']
                        .insuranceCalculationMethodId;
                    insurancePercentage = response['product'].insurancePercentage;
                    fixedInsuranceAmount = response['product'].fixedInsuranceAmount;

                    $('#loanAmount').val(response['product'].avgLoanAmount).trigger(
                        'input');

                    // if it is onetime loan than set interestCalMethod and interestRate
                    if (loanType == 'Onetime') {
        ...
        /* end get informations on selecting product */
        ...
        $("#loanCycle").on('input', function (e) {
            ...
            if (productId == '' || memberId == '' || $(this).val() == '') {
                return false;
            }
        ...
        $("#repaymentFrequencyId").change(function (e) {
            ...
            if (memberId == '' || productId == '' || repaymentFrequencyId == '' || disbursementDate ==
                '') {
                return false;
            }
        ...
        if (loanType == 'Regular') {
            $("#loanAmount").on('input', function () {
                ...
                $("#repayAmount, #ineterestAmount, #installmentAmount, #extraInstallmentAmount, #actualInstallmentAmount, #lastInstallmentAmount")
                    .val('');
        ...
        function getInterestNInstallmentInformation() {
            ...
            if (productId == '' || repaymentFrequencyId == '' || numberOfInstallment == '') {
                return false;
            }
        ...
        $('#firstGuarantorProfileImage').change(function (event) {
            ...
            $('#firstGuarantorProfileImagePreview').attr('src', URL.createObjectURL(event.target.files[
                0]));
        });
        $('#firstGuarantorSignatureImage').change(function (event) {
            $('#firstGuarantorSignatureImageText').val('');
            $('#firstGuarantorSignatureImagePreview').attr('src', URL.createObjectURL(event.target
                .files[0]));
        });
        ...
        $('#secondGuarantorProfileImage').change(function (event) {
            ...
            $('#secondGuarantorProfileImagePreview').attr('src', URL.createObjectURL(event.target.files[
                0]));
        });
        $('#secondGuarantorSignatureImage').change(function (event) {
            $('#secondGuarantorSignatureImageText').val('');
            $('#secondGuarantorSignatureImagePreview').attr('src', URL.createObjectURL(event.target
                .files[0]));
        });
        ...
        if ("{{$mfnGnlConfig->useWebCam}}" == 'yes') {
            ...
            document.getElementById('secondGuarantorSignatureSnap').addEventListener('click', function () {
                secondGuarantorSignatureContext.drawImage(secondGuarantorSignatureVideo, 0, 0, 340,
                    280);
