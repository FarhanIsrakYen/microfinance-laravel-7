...
class ProductColorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('POS.ProductColor.index', compact('ProdColorData'));
    }
    ...
    public function add(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($isInsert) {
                ...
                return Redirect::to('pos/color')->with($notification);
            } else {
                $notification = array(
            ...
            return view('POS.ProductColor.add',compact('ProdGroupData'));
        }
    }
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $ProdGroupData = PGroup::where('is_delete', 0)->orderBy('id', 'DESC')->get();
            return view('POS.ProductColor.edit', compact('ProdColorData','ProdGroupData'));
        }
    }
    ...
    {
        $ProdColorData = PColor::where('id', $id)->first();
        return view('POS.ProductColor.view', compact('ProdColorData'));
    }
