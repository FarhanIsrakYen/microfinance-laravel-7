        ...
        <div class="form-row align-items-center">
            ...
            <div class="col-lg-5">
                <div class="form-group">
                    ...
                    <div class="input-group ">
                        <input type="text" value="{{$PGroupData->sub_cat_name}}" class="form-control round"
                            id="brand_name" name="brand_name" placeholder="Enter Sub Category Name" required="required"
                            readonly>
                    </div>
                    <div class="help-block with-errors is-invalid"></div>
                </div>
