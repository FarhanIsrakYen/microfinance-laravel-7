...
class PModelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('POS.Model.index', compact('PModelData'));
    }
    ...
    public function add(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            if ($isInsert) {
                ...
                return Redirect::to('pos/model')->with($notification);
            } else {
                $notification = array(
            ...
            return view('POS.Model.add', compact('PgroupData', 'BrandData'));
        }
    }
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        return view('POS.Model.edit', compact('PgroupData', 'PModelData', 'BrandData'));
    }
    ...
    public function view($id = null)
    {
        ...
        return view('POS.Model.view', compact('PGroupData'));
    }
