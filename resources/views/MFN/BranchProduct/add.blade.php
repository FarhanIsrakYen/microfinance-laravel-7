                ...
                <div class="col-lg-6">
                    <div class="input-group">
                        <select class="form-control clsSelect2" name="branchId" 
                                                id="branchId" required data-error="Please Select Branche">
                    ...
                    <div class="input-group">
                        @foreach($loanProductList as $lproduct)
                            <div class="checkbox-custom checkbox-primary mr-4">
                                <input type="checkbox" name="loanProductIds[]" id="loanProduct_{{$lproduct->id}}" value="{{ $lproduct->id }}">
                ...
                <div class="col-lg-6">
                    <div class="input-group">
                        @foreach($savingsProductList as $sproduct)  
                            <div class="checkbox-custom checkbox-primary mr-4">
                                <input type="checkbox" name="savingProductIds[]" id="savingsProduct_{{$sproduct->id}}" value="{{ $sproduct->id }}">
