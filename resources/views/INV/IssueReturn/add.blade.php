                    ...
                    <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group ">
                                            <input type="text" class="form-control round"
                                                ...
                                                value="{{ INVS::generateBillIssueReturn(Common::getBranchId()) }}"readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-row form-group align-items-center">
                                <label class="col-lg-3 input-title">Issue Return Date</label>
...
function btnAddNewRow(TableID, ColumnNameS, ColumnIDS, TotalRowID) {
    ...
    if ($('#' + ColumnID[0] + 0).val() != '' && $('#product_quantity_0').val() > 0
        ...
        html += '<td class="input-group barcodeWidth" width="61%">';
