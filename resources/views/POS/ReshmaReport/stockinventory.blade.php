            ...
            <div class="row">
                <div class="table-responsive">
                    <table class="table w-full table-hover table-bordered table-striped clsDataTable" id="export-table" data-tableexport-display="always">
                        <thead>
                            <tr>
                                <th rowspan="4" width="2%">SL No</th>
                                <th rowspan="3" width="6%">Product Name</th>
                                <th rowspan="3">Model</th>
                                <th rowspan="3" width="6%">Barcode Number</th>
                                <th rowspan="2" colspan="2">Opening Stock</th>
                                <th colspan="8" class="text-center">Add Current Prieod</th>
                                <th colspan="8" class="text-center">Less Current Prieod</th>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="3"></td>
                                <td><b>TOTAL =</b></td>
                                <td><b style="border-bottom: 3px double;">0</b></td>
                                <td><b style="border-bottom: 3px double;">0</b></td>
                                <td><b style="border-bottom: 3px double;">0</b></td>
                                <td style="text-align: right;"><b style="border-bottom: 3px double;">0.00</b></td>
                                <td><b style="border-bottom: 3px double;">0</b></td>
                                <td style="text-align: right;"><b style="border-bottom: 3px double;">0.00</b></td>
                                <td><b style="border-bottom: 3px double;">0</b></td>
                                <td style="text-align: right;"><b style="border-bottom: 3px double;">0.00</b></td>
                                ...
                                <td style="text-align: right;"><b style="border-bottom: 3px double;">0.00</b></td>
                                <td style="text-align: right;"><b style="border-bottom: 3px double;">0.00</b></td>
                                <td><b style="border-bottom: 3px double;"></b></td>
                                <td style="text-align:right;"><b style="border-bottom: 3px double;">0.00</b></td>
                                <!-- <td><b style="border-bottom: 3px double;"></b></td> -->
                            </tr>
                        </tfoot>
...
<script>
    ...
    function ajaxDataLoad(start_date = null, end_date = null, branch_id = null, supplier_id = null, group_id = null,
        ...
        $('.clsDataTable').DataTable({
            ...
            searching: false,
            "ajax": {
                "url": "{{ route('STRInventoryDatatable') }}",
                "dataType": "json",
                "type": "post",
                "data": {
                    _token: "{{ csrf_token() }}",
    ...
    function fnDownloadExcel() {
        $('#export-table').tableExport({
            type: 'excel',
            fileName: 'stock report inventory',
        });
    }
