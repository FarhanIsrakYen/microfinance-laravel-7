        ...
        <div class="col-lg-9 pr-0">
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="form-row form-group align-items-center">
                        <label class="col-lg-1 input-title RequiredStar">Customer</label>
                        <div class="col-lg-2 input-group addSupplier">
                            ...
                            ?>
                            <select class="form-control round browser-default clsSelect2" name="customer_id"
                            id="customer_id" onchange="fnCustDataLoad();" required data-error="Please Select Customer">
                                {{-- onchange="fnCustDataLoad();" --}}
                                <option value="">Select</option>
                                @foreach($CustList as $CData)
                                <option value="{{ $CData->customer_no }}">
                ...
                <div class="panel-body p-4">
                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7 input-group">
                            ...
                            <label id="bill_date" class="text-black">{{ Common::systemCurrentDate() }}</label>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-7">
                            <div class="input-group">
                                <input type="hidden" name="bill_no"
                                    value="{{ BILLS::generateBillCash(Common::getBranchId()) }}" 
                                    class="form-control round" readonly>
                                <label id="bill_no" class="text-black">
                                    {{ BILLS::generateBillCash(Common::getBranchId()) }}
                                </label>
                            </div>
                ...
                <div class="panel-body" style="padding: 18px;">
                    ...
                    <div class="col-lg-12 pt-4">
                        <div class="d-flex justify-content-center">
                            ...
                            id="submitButtonforSales">Save</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        */
        if ($('#' + ColumnID[0] + 0).val() != '' && $('#product_quantity_0').val() > 0 ) {
            ...
            */
            ...
            var ProductQuantity = $('#' + ColumnID[2] + 0).val();
            ...
            if (flag === true){
                ...
                // $('#unit_sale_price_' + rowNumber).val(ProductSalePrice);
                // $('#product_sales_price_' + rowNumber).val(ProductAmount);
                ...
                // $('#' + ColumnID[7] + 0).val(0);
                // $('#' + ColumnID[8] + 0).val('');
                $('#' + ColumnID[2] + 0).prop('readonly', true);
                ...
                var ProductSalePrice = $('#' + ColumnID[0] + 0).find("option:selected").attr('pcprice');

                var ProductAmount = $('#' + ColumnID[4] + 0).val();

                var rowID = 'salesRow_' + TotalRowCount;
                var html = '<tr id="' + rowID + '">';

                html += '<td class="barcodeWidth" width="51%">';
                html += '<input type="hidden" id="product_id_'+ TotalRowCount +'" name="' + ColumnName[0] + '" value="' + ProductID + '">';

                html += '<input type="hidden" id="product_type_'+ TotalRowCount +'" name="' + ColumnName[5] + '" value="' + ProductType + '">';

                html += '<input type="text" class="form-control round" value="' + ProductName  +
                ...
                html += '<td width="4%">' +
                    ...
                    ColumnID[6] + TotalRowCount + '" onclick="btnRemoveRow(this);">' +
