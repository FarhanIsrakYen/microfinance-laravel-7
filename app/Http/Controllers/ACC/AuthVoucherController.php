...
class AuthVoucherController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $vdata = Voucher::where('is_delete', '=', 0)->where('voucher_status', '=', 1)->where('v_generate_type', '=', 0)
                ->whereIn('branch_id', HRS::getUserAccesableBranchIds())->get();
            return view('ACC.AuthVoucher.index', compact('vdata'));
        }
    }
