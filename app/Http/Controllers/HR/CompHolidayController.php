...
class CompHolidayController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('HR.CompanyHoliday.index', compact('CompHolidayData'));
    }
    ...
    public function add(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return view('HR.CompanyHoliday.add', compact('days'));
        }
    }
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return view('HR.CompanyHoliday.edit', compact('CompHolidayData', 'days'));
        }
    }
    ...
    public function view($id = null)
    {
        ...
        return view('HR.CompanyHoliday.view', compact('CompHolidayData', 'days'));
    }
