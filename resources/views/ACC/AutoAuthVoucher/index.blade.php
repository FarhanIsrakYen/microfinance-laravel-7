    ...
    <div class="row text-right p-10">
        ...
        <div class="col-lg-1">
            ...
            <a href="javascript:void(0)" id="btnSearch" onclick="fnAuthorizeAll();"
                class="btn btn-danger btn-round">Unauthorize</a>
        </div>
            ...
            <table class="table w-full table-hover table-bordered table-striped clsDataTable">
                <thead>
                    <tr>
                        ...
                        <th>Entry By</th>
                        <th><input type="checkbox" id="all_check_id" onclick="fnallCheck();" title="Select All" /></th>
                    </tr>
                </thead>
                <tbody></tbody>
            </table>
...
<script>
    ...
    function ajaxDataLoad(sDate = null, eDate = null, branchID = null, projectID = null,
        ...
        $('.clsDataTable').DataTable({
            ...
            // stateDuration: 1800,
            "ajax": {
                "url": "{{route('autoauthvoucherDatatable')}}",
                "dataType": "json",
                "type": "post",
                "data": {
                    _token: "{{csrf_token()}}",
    ...
    function fnAuthorizeAll() {
        ...
        swal({
                title: "Are you sure to unauthorized voucher ?",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
