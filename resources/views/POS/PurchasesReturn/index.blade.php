...
<div class="panel">
    ...
    $(document).ready(function() {
        ...
        $('#btnPurReturnSearch').click(function() {
            ...
            ajaxDataLoad(SDate, EDate, BranchID, ProductID, SupplierID);
        });
    ...
    function ajaxDataLoad(SDate = null, EDate = null, BranchID = null, ProductID = null, SupplierID = null) {
        ...
        $('.clsDataTable').DataTable({
            ...
            stateDuration: 1800,
            "ajax": {
                "url": "{{ route('purReturnIndexDtable') }}",
                "dataType": "json",
                "type": "post",
                "data": {
                    _token: "{{csrf_token()}}",
    ...
    function fnDelete(RowID) {
        ...
        fnDeleteCheck(
            "{{url('pos/purchase_return/delete/')}}",
            "{{url('/ajaxDeleteCheck')}}",
            RowID,
            "",
            "",
