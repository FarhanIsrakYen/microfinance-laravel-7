                        ...
                        <div class="col-lg-5 input-group">
                            <select name="bill_no" id="bill_no" class="form-control clsSelect2"
                                ...
                                <option value="{{ $bData->bill_no }}" bill_id="{{ $bData->id }}"
                                    ...
                                    {{ ($collectionData->bill_no == $bData->bill_no) ? 'selected' : '' }}>
                                    {{ $bData->bill_no }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-5">
                            <input type="text" class="form-control round onlyNumber textNumber text-right" placeholder="Enter Amount"
                                name="collection_amount" id="collection_amount" required value="{{ $collectionData->collection_amount }}" 
                        ...
                        <div class="col-lg-5 input-group">
                            <select name="payment_system_id" id="payment_system_id"
                                ...
                                <option value="{{ $PData->id }}"
                                    ...
                                    {{ $PData->payment_system_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
