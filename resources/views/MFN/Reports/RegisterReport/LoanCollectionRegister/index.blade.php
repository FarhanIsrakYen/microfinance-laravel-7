                ...
                <div class="col-lg-2">
                    ...
                    <div class="input-group">
                        ...
                        onchange="fnAjaxSelectBox('product_id',
                                    ...
                                    '{{base64_encode('id,productCode,name')}}',
                                    '{{url('/ajaxSelectBox')}}',
                                    '{{null}}',
                                    '{{'isActiveOff'}}'
                                            );">
                            <option value="">All</option>
                            @foreach ($LoanProductCatagory as $Row)
...
$(document).ready(function() {
   ...
   $("#filterFormId").submit(function( event ) {
    ...
    if( $("#branch_id").val() !=''){
        ...
        $("#reportingDiv").load('{{URL::to("mfn/reports/loan_collection_reg/loadData")}}'+'?'+$("#filterFormId").serialize());
    }else{
