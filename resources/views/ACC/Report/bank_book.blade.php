...
<div class="w-full show">
    <div class="panel">
        <div class="panel-body panel-search pt-2">
            ...
            @include('elements.report.report_heading', ['title' => 'Bank Book', 'title_excel' =>
            'Bank_Book', 'ledgerHead' => true, 'projectName' => true, 'projectTypeName' => true])
...
<script>
    function ajaxDataLoad(start_date = null, end_date = null, project_id = null, project_type_id = null,
        branch_id = null, ledger_bank = null, voucher_type_id = null) {
        ...
        $('.clsDataTable').DataTable({
            ...
            searching: false,
            "ajax": {
                "url": "{{route('BankBookReportDatatable')}}",
                "dataType": "json",
                "type": "post",
                "data": {
                    _token: "{{ csrf_token() }}",
    ...
    $(document).ready(function () {
        ...
        $('#searchButton').click(function () {
            ...
            var ledger_bank = $('#ledger_bank').val();
            ...
            $ledgerId = $('#ledger_bank option:selected').val();
            if ($ledgerId == '') {
                var ledger = $('#ledger_bank option:selected').text() + ' Ledger Head';
            } else
                var ledger = $('#ledger_bank option:selected').text();
            ...
            ajaxDataLoad(start_date, end_date, project_id, project_type_id, branch_id, ledger_bank,
                voucher_type_id);
        });
    });
