...
$issueData = Common::ViewTableOrder('inv_issues_d',
    [['is_delete', 0], ['is_active', 1]],
    ['id', 'issue_bill_no'],
    ['issue_bill_no', 'ASC']);
    ...
    <div class="panel">
        <div class="panel-body">
          <div class="row align-items-center pb-10 d-print-none">
                ...
                {!! HTML::forBranchFeildSearch_new('all', 'branch_id', 'Branch', null)!!}
                        ...
                        <table class="table w-full table-hover table-bordered table-striped clsDataTable">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-right" id="TotalSaleAmt"><b>0.00</b></td>
                                    <td class="text-right" id="service_charge"><b>0.00</b></td>
                                    <td class="text-right" id="total_payable_amount"><b>0.00</b></td>
                                    <td class="text-right" id="collection_amount"><b>0.00</b></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
