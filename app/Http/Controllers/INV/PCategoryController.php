...
class PCategoryController extends Controller
{
    ...
    {
        $PCategoryData = PCategory::where('inv_p_categories.is_delete', 0)->orderBy('inv_p_categories.id', 'DESC')->get();
        return view('INV.Category.index', compact('PCategoryData'));
    }
    ...
    public function add(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            if ($isInsert) {
                ...
                return Redirect::to('inv/category')->with($notification);
            } else {
                $notification = array(
        ...
        return view('INV.Category.add', compact('PGroupData'));
    }
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        $PGroupData = PGroup::where('is_delete', 0)->orderBy('id', 'DESC')->get();
        return view('INV.Category.edit', compact('PCategoryData', 'PGroupData'));
    }

    public function view($id = null)
    {
        $PCategoryData = PCategory::where('id', $id)->first();
        return view('INV.Category.view', compact('PCategoryData'));
    }
