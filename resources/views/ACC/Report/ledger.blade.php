...
<div class="w-full show">
    <div class="panel">
        <div class="panel-body panel-search pt-2">
            ...
            @include('elements.report.report_heading', ['title' => 'Ledger Report', 'title_excel' =>
            'Ledger_Report', 'ledgerHead' => true, 'projectName' => true, 'projectTypeName' => true])
...
<script>
    function ajaxDataLoad(start_date = null, end_date = null, project_id = null, project_type_id = null,
        ...
        $('.clsDataTable').DataTable({
            ...
            searching: false,
            "ajax": {
                "url": "{{route('ledgerReportDatatable')}}",
                "dataType": "json",
                "type": "post",
                "data": {
                    _token: "{{ csrf_token() }}",
    ...
    $(document).ready(function () {
        ...
        $('#searchButton').click(function () {
            ...
            $('#reportBranch').html($('#branch_id option:selected').text());

            var ledger = $('#ledger_id option:selected').text();
