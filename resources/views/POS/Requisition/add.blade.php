...
<form method="post" data-toggle="validator" novalidate="true" id="requisition_form_id">
    ...
    <div class="row">
        <div class="col-lg-6">
            {!! HTML::forBranchFeild(true, 'branch_from', 'branch_from', null, '','Requisition From', true) !!}
            <input type="hidden" name="company_id" value="{{ Common::getCompanyId() }}">
            <input type="hidden" name="branch_to" id="branch_to" value="1">
        </div>
    </div>
                ...
                <div class="col-lg-5">
                    <div class="form-group">
                        <div class="input-group ">
                            <input type="text" class="form-control round" id="requisition_no" name="requisition_no" 
                            placeholder="Requisition No" value="{{ POSS::generateBillRequisiton(Common::getBranchId()) }}" readonly>
                        </div>
                    </div>
                </div>
            </div>
