...
class AutoUnauthVoucherController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            // $QueryData = Voucher::where('is_delete', '=', 0)->where('voucher_status', '=', 0)->where('v_generate_type', '=', 1)
            ...
            $vdata = Voucher::where('is_delete', '=', 0)->where('voucher_status', '=', 0)->where('v_generate_type', '=', 1)
                ->whereIn('branch_id', HRS::getUserAccesableBranchIds())->get();

            return view('ACC.AutoUnauthVoucher.index', compact('vdata'));
        }
    }
    ...
    public function isAuth($id = null)
    {
        ...
        if ($voucherData->voucher_status == 0) {
