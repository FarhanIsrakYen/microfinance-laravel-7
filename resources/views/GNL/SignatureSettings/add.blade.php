                ...
                <div class="col-lg-12 offset-lg-1" id="headDivID">
                    ...
                    <div class="row" id="row_head_0">
                        ...
                        {{-- <div class="col-lg-1 form-group">
                            <a href="javascript:void(0)" class="btn btn-dark btn-floating btn-sm d-flex justify-content-center align-items-center" onclick="btnRemoveRowHead(0);">
