    		$requisitionData = DB::table('pos_requisitions_m as rm')
                ...
                <!-- <?php $i = 0; ?>
                    @foreach($requisitionData as $reqData)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('pos/requisition/view/'.$reqData->id) }}" title="View" class="btnView">
                    ...
                    /*$requistionData = DB::table('pos_orders_m as pom')
                ->where('pom.id', $id)
                ...
                {{-- view --}}
                {{-- $requisitionM = DB::table('pos_requisitions_d as prd')
                        ->where([['prd.is_delete', 0], ['prd.is_active', 1], ['prd.is_ordered', 0]])
