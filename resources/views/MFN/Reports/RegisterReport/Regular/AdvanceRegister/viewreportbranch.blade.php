...
<table class="table table-striped table-bordered">
    ...
    <tbody>
        ...
        @if (!isset($loans[$index-1]->samityId) )
        <tr>
            <td rowspan="{{$loans->where('samityId',$loans[$index]->samityId)->count()}}">{{++$i}}</td>
            <td rowspan="{{$loans->where('samityId',$loans[$index]->samityId)->count()}}">{{$Value->samity}}</td>
        ...
        @else
            @if ($loans[$index-1]->samityId != $loans[$index]->samityId) 
            <tr>
                <td rowspan="{{$loans->where('samityId',$loans[$index]->samityId)->count()}}">{{++$i}}</td>
                <td rowspan="{{$loans->where('samityId',$loans[$index]->samityId)->count()}}">{{$Value->samity}}</td>
                <td rowspan="{{$loans->where('memberId',$loans[$index]->memberId)->count()}}">{{$Value->memberCode}}</td>
...
<h6>Product Wise</h6>
    ...
    <table class="table table-striped table-bordered">
        ...
        <?php $i=0; $loans = $loans->groupBy('component');?>
...
<h6>Category Wise</h6>
    <table class="table table-striped table-bordered">
        ...
        <?php $i=0; $loans = $loans->groupBy('category');?>
