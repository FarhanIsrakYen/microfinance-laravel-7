...
<div class="row text-center  d-print-block">
    <div class="col-lg-12" style="color:#000;">
        ...
        <strong>Waiver Report</strong><br>
    </div>
</div>
...
<table class="table w-full table-hover table-bordered table-striped">
    <thead class="text-center">
        <tr>
            ...
            <th rowspan="2" class="text-center">Waiver Amount</th>
        </tr>
        <tr>
    ...
    <?php $i = 0; $totalLoanAmount = 0; $totalWaiverAmount = 0;
    ?>
    <tbody>
        @foreach ($waivers as $item)
            ...
            @php 
                ...
                $totalWaiverAmount += $item->waiverAmount;
            @endphp
            <tr>
                ...
                <td class="text-center">{{ \Carbon\Carbon::parse($item->waiverDate)->format('d-m-Y')}}</td>
                <td class="text-right">{{number_format($item->loanAmount,2)}}</td>
                <td class="text-right">{{number_format($item->waiverAmount,2)}}</td>
            </tr>
        @endforeach
    ...
    <tfoot>
        <tr>
            ...
            <td class="text-right"><b>{{number_format($totalWaiverAmount,2)}}</b></td>
        </tr>
    </tfoot>
</table>
