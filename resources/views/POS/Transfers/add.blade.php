            ...
            <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="input-group">
                                <input type="text" name="bill_no" id="bill_no" class="form-control round"
                                    readonly value="{{ POSS::generateBillTransfer(Common::getBranchId()) }}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7 ">
                            <div class="input-group">
                                <input type="text" name="order_no" id="order_no" class="form-control round" placeholder="Enter Order No">
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // Generate Bill On Changing Brannch
        ...
        // Load Product On Selecting Group, Cat And Sub Category
    ...
    // Calculate Quantity of Products
    ...
    // Calculate Price of All Product
