        ...
        <!-- Search Options -->
            <div class="row align-items-center pb-10 mb-4 d-print-none">
                ...
                <div class="col-lg-2">
                    ...
                    <div class="input-group">
                        <select class="form-control clsSelect2" name="productId">
                ...
                <div class="col-lg-2">
                    ...
                    <div class="input-group">
                        <select class="form-control clsSelect2" name="ProductType" id="product_id">
                            <option value="">Select One</option>
...
$(document).ready(function() {
   ...
   $("#filterFormId").submit(function( event ) {
    ...
    if( $("#branch_id").val() !=''){
        ...
        $("#reportingDiv").load('{{URL::to("mfn/reports/savings_closing/loadData")}}'+'?'+$("#filterFormId").serialize());
    }else{
