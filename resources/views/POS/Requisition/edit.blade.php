...
<form method="post" data-toggle="validator" novalidate="true" id="requisition_form_id">
    ...
    <div class="row">
        <div class="col-lg-6">
            {!! HTML::forBranchFeild(true, 'branch_from', 'branch_from', $requisitionM->branch_from, '','Requisition From', false) !!}
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-row align-items-center">
                <label class="col-lg-3 input-title">Requisition No</label>
                <div class="col-lg-5">
                    <div class="form-group">
                        <div class="input-group ">
                            <input type="text" class="form-control round" id="requisition_no" name="requisition_no" placeholder="Requisition No" value="{{ $requisitionM->requisition_no }}" readonly>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6">
            <div class="form-row align-items-center">
                <label class="col-lg-3 input-title">Requisiton Date</label>
                <div class="col-lg-5">
                    <div class="form-group">
                        <div class="input-group ">
                            <?php
                            ...
                            ?>
                            <input type="text" name="requisition_date" id="requisition_date" class="form-control round" 
                            value="{{ $ReqDate }}" placeholder="DD-MM-YYYY" readonly="true">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <table class="table table-hover table-striped table-bordered w-full text-center table-responsive mt-4" id="requisitionTable">
                ...
                <tbody class="scrollBody">
                        ...
                        <td width="61%" class="barcodeWidth">
                            <select id="product_id_0" class="form-control round clsSelect2" style="width: 100%;">
                                ...
                                <option value="{{ $product->id }}" pname="{{ $product->product_name }}"
                                    ...
                                    {{ $product->product_name." - ".$product->prod_barcode }}</option>
                                @endforeach
                            </select>
                        </td>
                    ...
                    <?php $i = 0; ?>
                        ...
                        <tr>
                            <td width="61%" class="barcodeWidth">
                                <input type="text" class="form-control round" value="{{ $reqD->product_name .' ('. $reqD->prod_barcode.')' }}" readonly>
