        ...
        <div class="col-lg-6">
                ...
                <div class="col-lg-5">
                    <div class="form-group">
                        <div class="input-group ">
                            <input type="text" class="form-control round" id="order_no" name="order_no" placeholder="Requisition No"
                            value="{{ $orderM->order_no }}" readonly>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="form-group">
                        <div class="input-group ">
                            <input type="text" name="order_date" id="order_date" class="form-control round" value="{{ $orderM->order_date }}" 
                ...
                <tbody class="scrollBody">
                    ...
                    <tr>
                        <td width="61%" class="barcodeWidth">
                        	<input type="text" class="form-control round" value="{{ $row->product_name .' ('. $row->prod_barcode.')' }}" readonly>
