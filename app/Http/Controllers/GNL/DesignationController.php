...
class DesignationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('GNL.Designation.index', compact('DesignationData'));
    }
    ...
    public function add(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return view('GNL.Designation.add');
        }
    }
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return view('GNL.Designation.edit', compact('DesignationData'));
        }
    }
    ...
    {
        $DesignationData = EmployeeDesignation::where('id', $id)->first();
        return view('GNL.Designation.view', compact('DesignationData'));
    }
