                ...
                <div class="col-lg-5">
                    <div class="form-group">
                        <div class="input-group ">
                            <input type="text" class="form-control round" id="requisition_no" name="requisition_no" placeholder="Requisition No" value="{{ INVS::generateBillRequisiton(Common::getBranchId()) }}" required="required" readonly>
                        </div>
                    </div>
                </div>
            </div>
...
function fnProductLoad() {
    ...
    var firstRowFirstColId = $('#requisitionTable tbody tr td:first-child select').attr('id');
