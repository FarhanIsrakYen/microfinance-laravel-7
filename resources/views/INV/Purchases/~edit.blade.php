                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-7 input-group">
                                        <select class="form-control clsSelect2" id="branch_id" disabled="true">
                                            
                                            <option value="0">{{ sprintf("%04d", 0)." - "}}Head Office</option>
                                            
                                            @foreach($BranchData as $BData)
                                            <option value="{{ $BData->id }}" @if($PurchaseData->branch_id ==
                                                $BData->id){{ 'selected' }}@endif>{{ sprintf("%04d", $BData->branch_code)." - ".$BData->branch_name }}</option>
                                            @endforeach
                                        </select>

                                    </div>
                                    {{-- <input type="hidden" name="branch_id" id="branch_id" value="{{ $BData->id }}"> --}}
                                </div>
                            </div>
                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="input-group barcodeWidth">
                                    ...
                                    <select id="product_id_0" class="form-control round clsProductSelect"
                                        data-style="btn-outline btn-primary" onchange="fnAjaxCheckStock();">
                            ...
                            @if(count($PurchaseDataD) > 0)
                                ...
                                <tr>
                                    <td class="input-group barcodeWidth">
                                        <input type="hidden" name="product_id_arr[]" value="{{ $PurData->product_id }}">
                                    ...
                                    <td>
                                        <input type="number" name="total_cost_price_arr[]" id="total_cost_price_{{ $i }}"
                                            class="form-control round ttlAmountCls" value="{{ $PurData->total_cost_price }}"
                                            min="1" readonly>
                                    </td>
    ...
    <div class="col-lg-12">
        ...
        <div class="form-row align-items-center">
            ...
            <div class="col-lg-8">
                <div class="form-group">
                    <div class="input-group ">
                        <textarea class="form-control round" rows="2" name="sup_attentionA" placeholder="Enter Attentions."></textarea>
                    </div>
                    {{-- <div class="help-block with-errors is-invalid"></div> --}}
                </div>
            </div>
...
function btnAddNewRow(TableID, ColumnNameS, ColumnIDS, TotalRowID) {
    ...
    if ($('#' + ColumnID[0] + 0).val() != '' && $('#product_quantity_0').val() > 0) {
        ...
        $('#prod_group_id').selectpicker('refresh');
