...
<div class="page">
    <div class="page-header">
        <h4 class="">Edit Product OB Due Sale</h4>
        <ol class="breadcrumb">
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <form enctype="multipart/form-data" method="post" class="form-horizontal"
                    action="{{url('/pos/product/obduesale/updateprodobduesale/'.$POBDueSaleData->id)}}"
                    ...
                    <div class="row ">
                        <div class="col-lg-9 offset-lg-3">
                            <!-- Html View Load  -->
                            <!-- {!! HTML::forCompanyFeild($POBDueSaleData->company_id) !!} -->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group ">
                                            <input type="text" class="form-control round" id="bill_no" name="bill_no"
                                                value="{{$POBDueSaleData->bill_no}}" placeholder="Enter Bill No"
                                                required="required">
                                        </div>
                                        <div class="help-block with-errors is-invalid"></div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group ">
                                            <input type="number" class="form-control round" id="sale_amount"
                                                ...
                                                placeholder="Enter Sale Amount" required="required">
                                        </div>
                                        <div class="help-block with-errors is-invalid"></div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group ">
                                            <input type="number" class="form-control round" id="installment_amount"
                                                ...
                                                placeholder="Enter Installment Amount" required="required">
                                        </div>
                                        <div class="help-block with-errors is-invalid"></div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group ">
                                            <input type="number" class="form-control round" id="due_amount"
                                                ...
                                                placeholder="Enter Due Amount" required="required">
                                        </div>
                                        <div class="help-block with-errors is-invalid"></div>
                                    </div>
                                </div>
