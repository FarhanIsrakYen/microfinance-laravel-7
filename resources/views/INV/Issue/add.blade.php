        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="input-group ">
                                    <input type="text" class="form-control round"
                                        ...
                                        value="{{ INVS::generateBillIssue(Common::getBranchId()) }}" required readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {!! HTML::forBranchFeild(true,'','branch_to',null,'','Branch To') !!}
             ...
             if ($('#total_quantity').val() > 0 && $('#product_id_0').val() == '') {
                ...
                if ($('#total_quantity').val() <= 0) {
                    swal({
                        icon: 'error',
                        title: 'Error',
                        text: 'Total  must be gratter than zero !!',
                    });
                } else{
                    swal({
                        icon: 'error',
