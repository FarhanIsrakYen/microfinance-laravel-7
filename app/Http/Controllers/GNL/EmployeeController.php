...
class EmployeeController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $EmployeeData = Employee::where(['hr_employees.is_delete' => 0])
                ...
                $totalData = Employee::where([ ['hr_employees.is_delete', 0], ['hr_employees.is_active', 1]])
                    ->whereIn('hr_employees.branch_id', HRS::getUserAccesableBranchIds())
                    ->count();
                  $totalFiltered = $totalData;
            ...
            return view('GNL.Employee.index', compact('EmployeeData'));
        }
    }
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return view('GNL.Employee.edit', compact('EmployeeData'));
        }
    }
    ...
    {
        $EmployeeData = Employee::where('employee_no', $id)->first();
        return view('GNL.Employee.view', compact('EmployeeData'));
    }
