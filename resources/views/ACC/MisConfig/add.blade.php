            ...
            <div class="form-row align-items-center">
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" class="form-control round" name="mis_name" id="mis_name" placeholder="Enter MIS Name">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            <div class="input-group ">
                                <input type="text" class="form-control round" name="table_field_name" id="table_field_name"  placeholder="Enter Table Field Name">
                            </div>
                        </div>
                    </div>
                </div>
