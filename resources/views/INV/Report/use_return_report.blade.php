...
$billNoData = Common::ViewTableOrder('inv_use_m',
    [['is_delete', 0], ['is_active', 1]],
    ['id', 'uses_bill_no'],
    ['uses_bill_no', 'ASC']);
            ...
            <div class="row align-items-center pb-10 d-print-none">
                ...
                <div class="col-lg-2">
                    ...
                    <div class="input-group">
                        <select class="form-control clsSelect2" name="uses_bill_no" id="uses_bill_no">
                            <option value="">Select All</option>
                            @foreach ($billNoData as $row)
        ...
        <div class="panel-body">
            ...
            <div class="row text-dark ExportHeading">
                <div class="col-xl-12 col-lg-12 col-sm-12 col-md-12 col-12" style="text-align:center;">
                    ...
                    <span>Uses Return Report</span><br>
            ...
            <div class="row d-print-none text-right">
                <div class="col-lg-12">
                    ...
                    <a href="javascript:void(0)" title="Excel" style="background-color:transparent;border:none;"
                        onclick="fnDownloadExcel('ExportHeading,ExportDiv', 'Uses_Return_Report_{{ (new Datetime())->format('d-m-Y') }}');">
                    ...
                    <table class="table w-full table-hover table-bordered table-striped clsDataTable">
                        <thead>
                            <tr>
                                ...
                                <th width="15%">Return Bill No</th>
                                <th width="15%">Uses Bill No</th>
                                <th width="15%">Branch</th>
                                <th>Product Name</th>
                                <th width="8%">Return Quantity</th>
                                <!-- <th>Unit Price</th>
                                <th>Total Amount</th> -->
                            </tr>
                        </thead>
...
<!-- End Page -->
<script>
function ajaxDataLoad(startDate = null, endDate = null, branchId = null, productId = null, usesBillNo = null) {
    ...
    $('.clsDataTable').DataTable({
        ...
        searching: false,
        "ajax": {
            "url": "{{route('INVuseRetDataTableReport')}}",
            "dataType": "json",
            "type": "post",
            "data": {
                _token: "{{csrf_token()}}",
...
$(document).ready(function() {
    ...
    $('#useSearch').click(function() {
        ...
        ajaxDataLoad(startDate, endDate, branchId, productId, usesBillNo);
    });
});
