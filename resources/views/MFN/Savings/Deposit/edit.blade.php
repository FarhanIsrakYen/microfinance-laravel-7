...
autocomplete="off">
    ...
    <div class="row">
        ...
        <div class="col-lg-7">
            ...
            <input type="hidden" name="depositId" value="{{ encrypt($deposit->id) }}">
            ...
            <div class="form-row form-group align-items-center">
                <label class="col-lg-3 input-title">Deposit Date</label>
                <div class="col-lg-5">
                    <div class="input-group">
                        <input type="text" class="form-control" name="date" value="{{ \Carbon\Carbon::parse($deposit->date)->format('d-m-Y') }}" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        ...
                        name="amount" id="amount" value="{{ $deposit->amount }}"
...
<script type="text/javascript">
    ...
    var initialAmount = "{{ $deposit->amount }}";
    var isAuthorized = "{{ $deposit->isAuthorized }}";
    ...
    $(document).ready(function () {
        ...
        function getAccountInfo(){
            $.ajax({
                type: "POST",
                url: "./../getData",
                data: {context : 'account', accountId : "{{ $deposit->accountId }}"},
                dataType: "json",
        ...
        $("#amount").on('input', function () {
            ...
            $('.balance').html(balance + (amount - initialAmount));

            if(isAuthorized == 1){
                $('.authorizedDeposit').html(authorizedDeposit + (amount - initialAmount));
            }
            else{
                $('.unauthorizedDeposit').html(unauthorizedDeposit + (amount - initialAmount));
            }

            $('.totalDeposit').html(totalDeposit + (amount - initialAmount));
        });
