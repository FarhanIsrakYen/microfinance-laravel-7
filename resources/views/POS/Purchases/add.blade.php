            ...
            <div class="row">
                        ...
                        <div class="col-lg-7 form-group">
                            <div class="input-group">
                                <input type="text" name="bill_no" id="bill_no" class="form-control round"
                                    value="{{ POSS::generateBillPurchase(Common::getBranchId()) }}" readonly>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7 input-group">
                                ...
                                <input type="text" name="purchase_date" id="purchase_date" class="form-control round" 
                    ...
                    <div class="form-group">
                        <div class="row align-items-center">
                            <?php
                                $orders = App\Model\POS\OrderMaster::where([['is_approve', 1], ['is_delivered', 0], ['is_completed', 0], ['is_active', 1], ['is_delete', 0]])->get();
                            ?>
                            <div class="col-lg-4">
                                <label for="textOrderNumber" class="input-title RequiredStar">Order No</label>
                            </div>
                            <div class="col-lg-7">
                    ...
                    <tr>
                        ...
                        <td width="15%">
                            ...
                            <input type="number" id="product_quantity_0" class="form-control round clsQuantity text-center"
                                ...
                                onkeyup="fnTotalQuantity(); fnTtlProductPrice(0);" min="1" readonly>
                        </td>
                        <td width="15%">
...
<script type="text/javascript">
    ...
    function btnAddNewRow(TableID, ColumnNameS, ColumnIDS, TotalRowID) {
         ...
         */
        if ($('#' + ColumnID[0] + 0).val() != '' && $('#product_quantity_0').val() > 0 && $('#supplier_id').val() != '' && $('#order_no').val() != '' &&  Number($('#product_id_0').find("option:selected").attr('prod_qtn') >= Number($('#product_quantity_0').val()))) {
            ...
            */
            ...
            if (flag === true){
                ...
                html += '<input type="text" class="form-control round text-left" value="' + ProductName + '(' + ProductSysBarcode + ')' +
                    '" readonly >';
                html += '</td>';
                html += '<td width="10%">';
            ...
            else if($('#order_no').val() == ''){
                swal({
                    icon: 'error',
                    title: 'Error',
                    text: 'Please select order no!',
                });
            }
            else{
                swal({
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data) {
                    ...
                    $("#contact_person").val(data.suplierName);
                    $.each(data.orderList, function (index, value) {
                        // console.log();
                            $("#order_no").append("<option value=" + value.order_no + ">" + value.order_no +
                                "</option>");
                        });
