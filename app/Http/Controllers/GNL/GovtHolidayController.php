...
class GovtHolidayController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('GNL.GovtHoliday.index', compact('GovtHolidayData'));
    }
    ...
    public function add(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return view('GNL.GovtHoliday.add');
        }
    }
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return view('GNL.GovtHoliday.edit', compact('GovtHolidayData'));
        }
    }
    ...
    public function view($id = null)
    {
        ...
        return view('GNL.GovtHoliday.view', compact('GovtHolidayData'));
    }
