...
<div class="row text-center  d-print-block">
    <div class="col-lg-12" style="color:#000;">
        ...
        <strong>Samity Wise Monthly Loan & Saving Collection Sheet2</strong><br>
    </div>
</div>
        ...
        @foreach ($memberDetails as $key => $value)
           ...
           <tr>
            ...
            @for ($j = 0; $j < $value->max; $j++)
                ...
                <th class="text-right">{{(MFN::getCloseWeekDate($weekday,$value->SavingsInfo[$j]->openingDate,$value->SavingsInfo[$j]->freequency))? number_format($value->SavingsInfo[$j]->autoProcessAmount, 2) : '0.00' }}</th>
                @endforeach
