...
<script>
    function ajaxDataLoad(){
        $('.clsDataTable').DataTable({
            ...
            serverSide: true,
            "ajax":{
                     "url": "{{route('workingareaDatatable')}}",
                     "dataType": "json",
                     "type": "post",
            ...
            //     $(td).html('<a href="./workingarea/view/'+cellData+'" title="View" class="btnView"><i class="icon wb-eye mr-2 blue-grey-600"></i></a> <a href="./workingarea/edit/'+cellData+'" title="Edit" class="btnEdit"><i class="icon wb-edit mr-2 blue-grey-600"></i></a> <a href="javascript:void(0)" onclick="fnDelete('+cellData+');" title="Delete" class=""><i class="icon wb-trash mr-2 blue-grey-600"></i></a>');
