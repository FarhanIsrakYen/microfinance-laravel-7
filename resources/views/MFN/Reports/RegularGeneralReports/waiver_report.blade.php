    ...
    <div class="panel-body pdf-export">
        <div class="row text-center d-print-block">
            <div class="col-lg-12" style="color:#000;">
                ...
                <span>All Waiver Report</span><br>
                    ...
                    <table class="table w-full table-hover table-bordered table-striped clsDataTable">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><b id="ttlWaiverAmount">0</b></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
       ...
       $("#filterFormId").submit(function( event ) {
        event.preventDefault();
            ...
            if( ($("#branch_id").val() !='') ){
                ...
                $("#reportingDiv").load('{{URL::to("mfn/reports/waiverReport/loadData")}}'+'?'+$("#filterFormId").serialize());
            }else{
                swal({
                                icon: 'warning',
        ...
        $('.clsDataTable').DataTable({
            ...
            drawCallback: function (oResult) {
                if (oResult.json) {
                    ...
                    $('#ttlWaiverAmount').html(oResult.json.ttlWaiverAmount);
                }
            }
