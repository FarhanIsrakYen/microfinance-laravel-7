        ...
        <div class="panel-body">
            ...
            <div class="row text-dark ExportHeading">
                <div class="col-xl-12 col-lg-12 col-sm-12 col-md-12 col-12" style="text-align:center;">
                    ...
                    <span>Stock Report (Branch)</span><br>
            ...
            <div class="row d-print-none text-right">
                <div class="col-lg-12">
                    ...
                    onclick="fnDownloadExcel('ExportHeading,ExportDiv', 'Stock_Report_Branch_{{ (new Datetime())->format('d-m-Y') }}');">
...
function ajaxDataLoad(start_date = null, end_date = null, branch_id = null, supplier_id = null, group_id = null,
    ...
    $('.clsDataTable').DataTable({
        ...
        searching: false,
        "ajax": {
            "url": "{{ url('inv/report/stock_branch') }}",
            "dataType": "json",
            "type": "post",
            "data": {
