                    ...
                    <div class="col-lg-2">
                        ...
                        <div class="input-group">
                            <select class="form-control clsSelect2" name="zone_id" id="zone_id">
                                ...
                                <option value="{{ $row->id}}" {{ ((empty($reqData)) ? '' : (($reqData['zone_id'] == $row->id) ? 'selected' : '')) }}>{{ $row->zone_name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        ...
                        <div class="input-group">
                            <select class="form-control clsSelect2" name="group_id" id="group_id" onchange="fnAjaxSelectBox('cat_id',
                                ...
                                <option value="{{ $row->id}}" {{ ((empty($reqData)) ? '' : (($reqData['group_id'] == $row->id) ? 'selected' : '')) }}>{{ $row->group_name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        ...
                        <div class="input-group">
                            <select class="form-control clsSelect2" name="cat_id" id="cat_id" onchange="fnAjaxSelectBox('sub_cat_id',
                                ...
                                <option value="{{ $row->id }}" {{ ((empty($reqData)) ? '' : (($reqData['cat_id'] == $row->id) ? 'selected' : '')) }}>{{ $row->cat_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        ...
                        <div class="input-group">
                            <select class="form-control clsSelect2" name="sub_cat_id" id="sub_cat_id" onchange="fnAjaxSelectBox('brand_id',
                                ...
                                <option value="{{ $row->id }}" {{ ((empty($reqData)) ? '' : (($reqData['sub_cat_id'] == $row->id) ? 'selected' : '')) }}>{{ $row->sub_cat_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2">
                        ...
                        <div class="input-group">
                            <select class="form-control clsSelect2" name="brand_id" id="brand_id" onchange="fnAjaxSelectBox('model_id',
                                ...
                                <option value="{{ $row->id }}" {{ ((empty($reqData)) ? '' : (($reqData['brand_id'] == $row->id) ? 'selected' : '')) }}>{{ $row->brand_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2">
                        ...
                        <div class="input-group">
                            <select class="form-control clsSelect2" name="model_id" id="model_id" onchange="fnAjaxSelectBox('product_id',
                                ...
                                <option value="{{ $model->id }}" {{ ((empty($reqData)) ? '' : (($reqData['model_id'] == $model->id) ? 'selected' : '')) }}>{{ $model->model_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
        ...
        <div class="panel-body">
            ...
            <div class="row text-dark ExportHeading">
                <div class="col-xl-12 col-lg-12 col-sm-12 col-md-12 col-12" style="text-align:center;">
                    ...
                    <span>Zone Wise Sales Report</span><br>
            ...
            <div class="row d-print-none text-right">
                <div class="col-lg-12">
                    ...
                    onclick="fnDownloadExcel('ExportHeading,ExportDiv', 'Zone_Sales_Report_{{ (new Datetime())->format('d-m-Y') }}');">
