...
<form enctype="multipart/form-data" method="post" class="form-horizontal" data-toggle="validator" novalidate="true"
    ...
    <div class="row">
        <div class="col-lg-10 offset-lg-3">
            ...
            <input type="hidden" name="loanId" value="{{ encrypt($loan->id) }}">

            <div class="form-row form-group align-items-center">
                <label class="col-lg-3 input-title">Loan</label>
                <div class="col-lg-5">
                    <div class="input-group">
                        <input type="text" class="form-control round" value="{{ $loan->loanCode }}" readonly>
                    </div>
                </div>
            </div>
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        <input type="text" name="installmentNo" class="form-control round" value="{{ $installmentNumber }}" readonly>
                    </div>
                </div>
            </div>
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        <input type="text" class="form-control round" name="previosDate"
                            value="{{ date('d-m-Y', strtotime($scheduleDate)) }}" readonly>
                    </div>
                </div>
            </div>
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        <input type="text" class="form-control round textNumber" name="numberOfTerm" id="numberOfTerm" required>
                    </div>
                </div>
            </div>
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        <input type="text" class="form-control round" name="rescheduleDate" id="rescheduleDate" readonly>
                    </div>
                </div>
            </div>
