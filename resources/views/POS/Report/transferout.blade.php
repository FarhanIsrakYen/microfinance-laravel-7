            ...
            <div class="row align-items-center pb-10 d-print-none">
                ...
                <div class="col-lg-2">
                    ...
                    <div class="input-group">
                        ...
                        onchange="fnAjaxSelectBox('cat_id',
                                                    this.value,
            ...
            <div class="row align-items-center pb-10 d-print-none">
                ...
                <div class="col-lg-2">
                    ...
                    <div class="input-group">
                        ...
                        onchange="fnAjaxSelectBox('brand_id',
                                                    this.value,
...
function ajaxDataLoad(startDate = null, endDate = null, branchId = null, productId = null, groupId = null, catId = null, subCatId = null, modelID = null){
    ...
    $('.clsDataTable').DataTable({
      ...
      searching: false,
            ...
            columns: [
                { data: 'id'},
                { data: 'transfer_date', className: 'text-center'},
    ...
    $(document).ready( function () {
        ...
        $('#transferSearch').click(function(){
            ...
            ajaxDataLoad(SDate, EDate, BranchID, ProductID, PGroupID, CategoryId, SubCatID, ModelID);
        });
    });
    function fnDownloadPDF()
    {
        $('.clsDataTable').tableExport({type:'pdf',
                                fileName: 'Transfer Out report',
                                jspdf: {orientation: 'l',
                                       format: 'a4',
    ...
    {
        $('.clsDataTable').tableExport({type:'excel',
                                        fileName: 'Transfer Out report',
                                    });
    }
