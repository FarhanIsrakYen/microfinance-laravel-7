...
class SpecialHolidayController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('HR.SpecialHoliday.index');
    }
    ...
    public function add(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return view('HR.SpecialHoliday.add', compact('CompanyData', 'BranchData'));
        }
    }
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $BranchData = Branch::where(['is_delete' => 0, 'is_approve' => 1])
                ->orderBy('branch_code', 'ASC')
                ->get();
            return view('HR.SpecialHoliday.edit', compact('SpecialHolidayData', 'CompanyData', 'BranchData'));
        }
    }
    ...
    public function view($id = null)
    {
        ...
        $BranchData = Branch::where(['is_delete' => 0, 'is_approve' => 1])
            ->orderBy('branch_code', 'ASC')
            ->get();
        return view('HR.SpecialHoliday.view', compact('SpecialHolidayData', 'CompanyData', 'BranchData'));
    }
