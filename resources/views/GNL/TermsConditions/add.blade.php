            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="form-group">
                        <div class="">
                            <input type="text" class="form-control round" id="tc_name" name="tc_name" placeholder="Enter Terms & Conditions Name" required="true" required data-error="Please enter Terms & Conditions Name.">
                        </div>
