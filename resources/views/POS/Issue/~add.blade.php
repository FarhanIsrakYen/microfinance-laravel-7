...
<div class="page">
    ...
    <div class="page-content">
        <form action="{{url('/pos/issue/add')}}" method="POST" data-toggle="validator" novalidate="true" id="form_id">
            @csrf
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="row ">
                        <div class="col-lg-12 offset-lg-1">
                            <!-- Html View Load  -->
                            <input type="hidden" id="issue_date" name="issue_date" value="{{ date('d-m-Y') }}">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-row align-items-center ">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="form-group">
                                                <div class="input-group ">
                                                    <select class="form-control clsSelect2" name="branch_to"
                                                        id="branch_to" required
                                                        data-error="Please select Product group" onchange="">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group ">
                                                    <input type="text" class="form-control round"
                                                        ...
                                                        value="{{ Common::generateBillIssue(Common::getBranchId()) }}" required readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
