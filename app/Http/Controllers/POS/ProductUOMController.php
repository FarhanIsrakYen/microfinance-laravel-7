...
class ProductUOMController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('POS.ProductUOM.index', compact('ProdUOMData'));
    }
    ...
    public function add(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($isInsert) {
                ...
                return Redirect::to('pos/uom')->with($notification);
            } else {
                $notification = array(
            ...
            return view('POS.ProductUOM.add');
        }
    }
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return view('POS.ProductUOM.edit', compact('ProdUOMData'));
        }
    }
    ...
    {
        $ProdUOMData = PUOM::where('id', $id)->first();
        return view('POS.ProductUOM.view', compact('ProdUOMData'));
    }
