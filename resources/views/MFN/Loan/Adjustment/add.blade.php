...
<script>
    ...
    function fnCheckAmount(row) {

        var value = Number($('#amount_'+row).val());
        var savingAmount = Number($('#savingAmt_'+row).val());

        if (value > savingAmount) {
            swal({
                icon: 'error',
                title: 'Oops...',
                text: 'Please enter your amount less than saving amount!!',
            });
