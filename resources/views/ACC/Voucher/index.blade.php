...
<div class="row text-center p-10">
    <div class="col-lg-12">
        <!-- style="height: 93%; background-color:#ea7b7b;" -->
        <a href="javascript:void(0)" name="btnSearch" class="btn btn-primary btn-round" id="btnSearch">Search</a>
    </div>
</div>
<!-- Search Option End -->
        ...
        <table class="table w-full table-hover table-bordered table-striped clsDataTable">
            <thead>
                <tr>
                    ...
                    <th width="12%">Voucher Code</th>
                    <th width="10%">Voucher Type</th>
                    <th width="7%">Project Type</th>
                    <th>Branch Name</th>
                    <th>Amount</th>
                    <th width="12%">Global Narration</th>
