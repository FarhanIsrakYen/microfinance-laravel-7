...
<form enctype="multipart/form-data" method="POST" data-toggle="validator" novalidate="true">
    ...
    <div class="row">
        <div class="col-lg-9 offset-lg-3">
            ...
            <!-- Html View Load  -->
            <!-- {!! HTML::forCompanyFeild($ProdInstPackData->company_id) !!} -->
                ...
                <div class="col-lg-5 form-group">
                    <div class="input-group">
                        <input type="text" class="form-control round" placeholder="Enter Month" name="prod_inst_month"
                            id="textprod_inst_month" value="{{$ProdInstPackData->prod_inst_month}}" required
                            data-error="Please enter Product Istallment Package.">
                    </div>
                ...
                <div class="col-lg-5 form-group">
                    <div class="input-group">
                        <input type="text" class="form-control round" placeholder="Enter Profit" name="prod_inst_profit"
                            id="textprod_inst_profit" value="{{$ProdInstPackData->prod_inst_profit}}" required
                            data-error="Please enter Product Istallment Profit.">
                    </div>
                    <div class="help-block with-errors is-invalid"></div>
                </div>
            </div>
