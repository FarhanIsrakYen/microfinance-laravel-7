    ...
    <div class="row">
        ...
        <div class="col-lg-6">
                ...
                <div class="col-lg-7 form-group">
                    <div class="input-group">
                        ...
                        <select name="supplier_id" id="supplier_id" class="form-control clsSelect2" required
                            data-error="Please select Supplier Name." onchange="fnGeneratebarcode();">
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-7 form-group">
                    <div class="input-group">
                        <select class="form-control clsSelect2" required data-error="Please select Brand."
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-7 form-group">
                    <div class="input-group">
                        <input type="text" class="form-control round" name="warranty" id="warranty"
                ...
                <div class="col-lg-7 form-group">
                    <div class="input-group">
                        <input type="text" class="form-control round" name="service_warranty" id="service_warranty"
                            placeholder="Enter Service Warranty. ">
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-7 form-group">
                    <div class="input-group">
                        <input type="text" class="form-control round" name="compresse_warranty" id="compresse_warranty"
                            placeholder="Enter Compresse Warranty ">
        ...
        <div class="col-lg-6">
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-7 form-group">
                    ...
                    <div class="help-block is-invalid" ></div>
                </div>
            </div>
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-7 form-group">
                    <div class="input-group">
                        <input type="number" name="sale_price" id="sale_price" class="form-control round"
                            placeholder="Enter Sale Price." required data-error="Please fill up sale price.">
                            <!-- onblur="fnGeneratebarcode();" -->
                    </div>
                    <div class="help-block with-errors is-invalid"></div>
                </div>
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-7 form-group">
                    <div class="input-group">
                        <input type="text" class="form-control round" placeholder="Enter Product Barcode"
                            name="prod_barcode" id="prod_barcode">
                    </div>
                </div>
            </div>
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-7 form-group">
                    <div class="input-group">
                        <input type="text" name="sys_barcode" id="sys_barcode" class="form-control round"
                            placeholder="System Generated Barcode" readonly>

                    </div>
                    <br>
                    <input type="hidden" id="barcode_image" name="barcode_image">

                    <div id="divBarImage"></div>
                </div>
            </div>
