...
<script>
    function ajaxDataLoad(branchId){
        $('.clsDataTable').DataTable({
            ...
            serverSide: true,
            "ajax":{
                    "url": "{{route('openingLoanDatatable')}}",
                    "dataType": "json",
                    "type": "post",
                    "data":{
                            _token: "{{csrf_token()}}",
            ...
            "columnDefs": [ {
              ...
              "createdCell": function (td, cellData, rowData, row, col) {
                ...
                $(td).html('<a href="./openingLoanInfo/view/'+cellData+'" title="View" class="btnView"><i class="icon wb-eye mr-2 blue-grey-600"></i></a> <a href="./openingLoanInfo/edit/'+cellData+'" title="Edit" class="btnEdit"><i class="icon wb-edit mr-2 blue-grey-600"></i></a> <a href="javascript:void(0)" onclick="fnDelete('+cellData+');" title="Delete" class=""><i class="icon wb-trash mr-2 blue-grey-600"></i></a>');
    ...
    function fnDelete(rowID) {
        ...
        .then((isConfirm) => {
            ...
            console.log(row);
            $.ajax({
                url: './openingLoanInfo/delete/'+ rowID,
                type: 'POST',
                dataType: 'json',
                data: {wareaId : rowID},
            })
