...
@section('content')
    ...
    <div class="row align-items-center pb-10 mb-4">
        ...
        <div class="col-lg-2">
            ...
            <div class="input-group">
                <input type="text" class="form-control" id="name_or_code" name="name_or_code" placeholder="Samity Name/Code"
