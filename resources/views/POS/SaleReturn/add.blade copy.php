                            ...
                            <table class="table table-hover table-striped table-bordered w-full text-center" id="salesReturnTable">
                                ...
                                <tbody class="scrollBody">
                                    ...
                                    <tr>
                                        ...
                                        <td width="15%">
                                            <input type="number" id="unit_cost_price_0"
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data) {
                        ...
                        $( "#tbodydetails tr td:nth-child(3), td:nth-child(4)" ).css( "text-align", "right" );
...
function fnCheckQuantity(Row) {
    ...
    if (Row === 0) {
        ...
        if (Number($('#product_quantity_0').val()) > Number($('#product_id_0').find("option:selected").attr(
                'pquantity'))) {
            chkFlag = false;
            $('#product_quantity_0').val($('#product_id_0').find("option:selected").attr('pquantity'));
        }

    } else {


        if (Number($('#product_quantity_' + Row).val()) > Number($('#product_id_' + Row).attr('pquantity'))) {
            chkFlag = false;
            $('#product_quantity_' + Row).val($('#product_id_' + Row).attr('pquantity'));
        }
