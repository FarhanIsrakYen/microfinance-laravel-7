    ...
    <div class="row">
        ...
        <div class="col-lg-7">
            ...
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        <input type="text" class="form-control" name="rebateDate" value="{{ Carbon\Carbon::parse($sysDate)->format('d-m-Y') }}" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        <input type="text" class="form-control textNumber" name="rebateAmount" id="rebateAmount" required data-error="Please give Amount">
                    </div>
                    <div class="help-block with-errors is-invalid"></div>
                </div>
            </div>
...
<script>
    ...
    $('#branchId').change(function(e) {
        ...
        // $('#samityId').selectize()[0].selectize.clear();
