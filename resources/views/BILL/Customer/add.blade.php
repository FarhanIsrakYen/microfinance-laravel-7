...
<form enctype="multipart/form-data" method="post" data-toggle="validator"  novalidate="true" autocomplete="off">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
                ...
                <div class="col-lg-7 form-group">
                    <div class="input-group">
                        <input type="text" class="form-control round" id="billing_name"
                            ...
                            data-error="Please enter Billing Name.">
                    </div>
            ...
            <div class="form-row align-items-center">
                <label class="col-lg-4 input-title RequiredStar" for="customer_code">Customer
                    Code</label>
                <div class="col-lg-7 form-group">
                    <div class="input-group">
                        <input type="text" class="form-control round" name="customer_code"
                            id="checkDuplicateCode" placeholder="Enter Coustomer Code" required
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-7 form-group">
                    <div class="input-group">
                        ...
                        <div class="radio-custom radio-primary" style="margin-left: 20px!important;">
                            <input type="radio" id="m3" name="marital_status" class="mStatus"
                                value="Divorced">
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-7 form-group">
                    <div class="input-group">
                        <input type="text" pattern="[01][0-9]{10}" class="form-control round textNumber" name="customer_mobile"
                ...
                <div class="col-lg-7 form-group">
                    <div class="input-group">
                        <textarea class="form-control round" id="present_addr"
                            ...
                            data-error="Please enter Present Address."></textarea>
                    </div>
                </div>
                ...
                <div class="col-lg-7 form-group">
                    <div class="input-group">
                        <textarea class="form-control round" id="permanent_addr"
                            ...
                            data-error="Please enter Permanent Address."></textarea>
                    </div>
                </div>
            </div>
