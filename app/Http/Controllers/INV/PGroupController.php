...
class PGroupController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('INV.Group.index', compact('PGroupData'));
    }
    ...
    public function add(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            if ($isInsert) {
                ...
                return Redirect::to('inv/group')->with($notification);
            } else {
                $notification = array(
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return view('INV.Group.edit', compact('PGroupData'));
        }
    }
    ...
    {
        $PGroupData = PGroup::where('id', $id)->first();
        return view('INV.Group.view', compact('PGroupData'));
    }
