                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-7 input-group">
                                        ...
                                        <input type="text" name="purchase_date" id="purchase_date"
                                            class="form-control round" value="{{ date('d-m-Y') }}" readonly="true"
                                            required>
                                    </div>
                                    <div class="help-block with-errors is-invalid"></div>
                                </div>
...
function fnPurAjaxModelSelect(ModelID) {
    ...
    if (GroupID != '' && CategoryID != '' && SubCatID != '') {
        ...
        swal({
            icon: 'error',
            title: 'Oops...',
            text: 'Please Select Group, Category & Sub Category !',
        });
    }
}
...
$('#company_id').change(function() {
    ...
    //function for get supplier data
    // $('#company_id').val(this.value);
    // console.log($('#company_id').val());

    //function for generate bill no.
