...
<form enctype="multipart/form-data" method="post" class="form-horizontal" data-toggle="validator" novalidate="true">
    ...
    <div class="row">
        <div class="col-lg-9 offset-lg-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group ">
                                <select class="form-control clsSelect2"
                                    name="prod_group_id" id="prod_group_id" required
            ...
            <option value="{{ $Row->id }}" @if($Row->id==$PbrandData->prod_group_id)
    ...
    <div class="form-row align-items-center">
        ...
        <div class="col-lg-5">
            <div class="form-group">
                ...
                <div class="input-group ">
                    <input type="text" value="{{$PbrandData->brand_name}}" class="form-control round" id="brand_name"
                        name="brand_name" placeholder="Enter Brand Name" required="required">
                </div>
