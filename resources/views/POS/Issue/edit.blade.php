                        ...
                        <div class="form-group">
                            <div class="input-group ">
                                <input type="text" class="form-control round"
                                    ...
                                    value="{{$Issuem->bill_no}}" readonly>
                            </div>
                        </div>
                    </div>
                </div>

                {!! HTML::forBranchFeild(true,'branch_to','branch_to',$Issuem->branch_to,'disabled','Branch To', true) !!}
            ...
            <div class="col-lg-6">
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-lg-5">
                        ...
                        id="requisition_no" onchange="fnGetReqProduct()">
                ...
                <tbody class="scrollBody">
                    ...
                    <tr>
                        <td width="50%" class="barcodeWidth">
                            ...
                            <input type="hidden" id="stock_quantity_{{ $i }}" value="{{(double)POSS::stockQuantity($Issuem->branch_from,$Data->product_id ) + (double)$Data->product_quantity}}">
