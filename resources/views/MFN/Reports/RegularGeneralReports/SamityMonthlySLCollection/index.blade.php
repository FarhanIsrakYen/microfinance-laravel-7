        ...
        <!-- Search Options -->
            <div class="row align-items-center pb-10 mb-4 d-print-none">
                ...
                <div class="col-lg-2">
                    ...
                    <div class="input-group">
                        <select class="form-control clsSelect2" name="day" id="day_id">
                ...
                <div class="col-lg-2">
                    ...
                    <div class="input-group">
                        <select class="form-control clsSelect2" name="member_code_show">
...
$(document).ready(function() {
   ...
   $("#filterFormId").submit(function( event ) {
    ...
    if( $("#branch_id").val() !='' && $("#year_id").val() !='' && $("#month_id").val() !='' ){
        ...
        $("#reportingDiv").load('{{URL::to("mfn/reports/collection_sheet/loadMfnCollectionReport")}}'+'?'+$("#filterFormId").serialize());
    }else{

        swal({
                            icon: 'warning',
                            title: 'Select Search Field',
                            text: 'You have have to select Branch , Year, Month, Day and Samity.',
                        });
