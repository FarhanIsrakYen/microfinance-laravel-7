                            ...
                            <div class="form-row form-group align-items-center">
                                ...
                                <div class="col-lg-8 input-group addSupplier">
                                    ...
                                    id="customer_id" onchange="fnCustDataLoad();">
                                        ...
                                        <option value="{{ $CData->customer_no }}" mobile_no="{{ $CData->customer_mobile }}" nid_no="{{ $CData->customer_nid }}">
        ...
        <div class="col-lg-3">
                ...
                <div class="panel-body p-4">
                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7 input-group">
                            <input type="hidden" name="sales_date" class="form-control round"
                                value="{{ Common::systemCurrentDate() }}" readonly="true">
                            <label id="sales_date" class="text-black">{{ Common::systemCurrentDate() }}</label>
                        </div>
                    </div>
                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7">
                            <div class="input-group">
                                <input type="hidden" name="sales_bill_no"
                                    value="{{ POSS::generateBillSales(Common::getBranchId()) }}" 
                                    class="form-control round" readonly>
                                <label id="sales_bill_no" class="text-black">
                                    {{ POSS::generateBillSales(Common::getBranchId()) }}
                                </label>
                            </div>
                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7 input-group">
                            ...
                            <select required class="form-control clsSelect2" name="employee_id" id="employee_id">
                                <option value="">Select</option>
            ...
            <div class="panel">
                <div class="panel-body" style="padding: 18px;">
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7">
                            <input type="number" name="discount_rate" id="discount_rate"
                                class="form-control round text-right" value="0" onkeyup="fnCalDiscount(this.value);">
                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7">
                            <input type="number" name="vat_rate" id="vat_rate" class="form-control round text-right"
                                value="0" onkeyup="fnCalVat(this.value);">
                    ...
                    <div class="form-row form-group align-items-center">
                        <label class="col-lg-5 input-title">Total Payable &nbsp &nbsp Amount</label>
                        <div class="col-lg-7">
                            <input type="text" name="total_payable_amount" id="total_payable_amount" 
                            class="form-control round text-right" value="0" readonly min="1">

                            {{-- paid amount --}}
                            <input type="hidden" name="paid_amount" id="paid_amount" class="form-control round text-right" value="0">
                            {{-- due amount --}}
                            <input type="hidden" name="due_amount" id="due_amount" class="form-control round text-right" value="0" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7 input-group">
                            <select class="form-control clsSelect2" name="payment_system_id" id="payment_system_id" required>
                    ...
                    {{-- <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7">
                            <input type="number" name="paid_amount" id="paid_amount" class="form-control round" value="0" onkeyup="fnCalDue(this.value);" required min="1">
                        </div>
                    </div>
                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7">
                            <input type="number" name="due_amount" id="due_amount" class="form-control round" value="0" readonly>
                        </div>
                    </div> --}}
                    ...
                    <div class="col-lg-12 pt-4">
                        <div class="d-flex justify-content-center">
                            ...
                            @if(Common::getBranchId() != 1)
                                <button type="submit" name="submitButtonforPurchase" class="btn btn-primary btn-round ml-2" id="submitButtonforSales">Save</button>
                            @endif
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        // Onchanging Product Group,Cat and Subcat,Load Product
        ...
        if ($('#' + ColumnID[0] + 0).val() != '' && $('#product_quantity_0').val() > 0 && $('#stock_quantity_0').val() != 0
            ...
            */
            ...
            if (flag === true){
                ...
                var rowID = 'salesRow_' + TotalRowCount;
