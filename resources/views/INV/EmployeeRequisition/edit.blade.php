            ...
            <div class="row">
                <div class="col-lg-6">
                            ...
                            <div class="input-group">
                                ...
                                required data-error="Please Select Employee">
                                    ...
                                    @foreach($employeeData as $emp)
                                        <option value="{{ $emp->employee_no }}" {{ $emp->employee_no ==  $requisitionM->emp_from ? 'selected' : '' }}>
                                            {{ $emp->emp_name." (".$emp->emp_code.")" }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7">
                            <div class="input-group">
                                <input type="text" class="form-control round" id="requisition_no" name="requisition_no" placeholder="Requisition No" value="{{ $requisitionM->requisition_no }}" required="required" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7">
                            <div class="input-group">
                                <?php
                                    $ReqDate = new DateTime($requisitionM->requisition_date);
                                    $ReqDate = (!empty($ReqDate)) ? $ReqDate->format('d-m-Y') : Common::systemCurrentDate();
                                ?>
                                <input type="text" name="requisition_date" id="requisition_date" class="form-control round" value="{{ $ReqDate }}" placeholder="DD-MM-YYYY" readonly="true" required>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <input type="hidden" name="branch_id" id="branch_id" value="{{ $requisitionM->branch_id }}">
                        ...
                        <div class="col-lg-7">
                            <div class="input-group">
                                <div class="radio-custom radio-primary col-lg-3">
                                    ...
                                    name="requisition_for" value="1" {{ $requisitionM->requisition_for == 1 ? 'checked' : '' }}>
                                    <label for="r1">Personal</label>
                                </div>
                                <div class="radio-custom radio-primary col-lg-3">
                                    <input type="radio" class="reqFor" id="r2" 
                                    name="requisition_for" value="2" {{ $requisitionM->requisition_for == 2 ? 'checked' : '' }}>
                            ...
                            <div class="input-group">
                                ...
                                name="dept_id" id="dept_id" style="width: 100%;" 
                                 onchange="fnAjaxSelectBox(
                                    ...
                                    <option value="{{ $Row->id }}" {{ $requisitionM->dept_id == $Row->id ? 'selected' : '' }}>
                        ...
                        <div class="col-lg-7">
                            <div class="input-group">
                                ...
                                name="room_id" id="room_id" style="width: 100%;">
                                    ...
                                    <option value="{{ $Row->id }}" {{ $requisitionM->room_id == $Row->id ? 'selected' : '' }}>
            ...
            <table class="table table-hover table-striped table-bordered w-full text-center table-responsive mt-4" id="requisitionTable">
                ...
                <tbody class="scrollBody">
                    ...
                    <?php $i = 0; ?>
                        ...
                        <tr>
                            <td width="61%" class="input-group barcodeWidth">
                            	<input type="text" class="form-control round" value="{{ $reqD->product_name }}" readonly>
                            ...
                            <td width="35%">
                                ...
                                name="product_quantity_arr[]" class="form-control round clsQuantity" style="text-align:center;"
                                 value="{{ $reqD->product_quantity }}"
    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-11">
            <textarea class="form-control round" id="remarks" name="remarks"
                rows="1" placeholder="Enter Remarks">{{ $requisitionM->remarks }}</textarea>
        </div>
    </div><br>
