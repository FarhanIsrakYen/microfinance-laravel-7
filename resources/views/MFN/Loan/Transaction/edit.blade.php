...
<form enctype="multipart/form-data" method="post" class="form-horizontal" data-toggle="validator" novalidate="true" autocomplete="off">
    ...
    <input type="hidden" name="samityId" id="samityId" value="{{ $samityId }}">
    <input type="hidden" name="branchId" id="branchId" value="{{ $branchId }}">
    <input type="hidden" name="loanId" id="loanId_hidden" value="{{ $loanId }}">
    ...
    <div class="row">
        ...
        <div class="col-lg-7">
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        {{-- <select class="form-control" name="memberId" id="memberId" required
                            data-error="Please Select Member" disabled>
                        </select> --}}
                        <input type="text" class="form-control" name="memberId" id="memberId" value="{{$memberName}} - {{$memberCode}}" readonly>
                    </div>
            ...
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="loanId" id="loanId" value="{{$loanCode}}" readonly>
                    </div>
                    <div class="help-block with-errors is-invalid"></div>
                </div>
            </div>
            ...
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        <input type="text" class="form-control" name="collectionDate" value="{{ Carbon\Carbon::parse($collectionDate)->format('d-m-Y') }}" readonly>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        <select class="form-control" name="paymentType" id="paymentType" required
                            ...
                            <option value="Bank" @if($paymentType == 'Bank'){{ 'selected' }}@endif>Bank</option>
                        </select>
                    </div>
                    <div class="help-block with-errors is-invalid"></div>
                </div>
            ...
            <div id="bankDiv" style="display: none;">
                ...
                <div class="form-row form-group align-items-center">
                    ...
                    <div class="col-lg-5">
                        <div class="input-group">
                            <input type="text" class="form-control" name="chequeNo" value="{{ $chequeNo }}">
                        </div>
                        <div class="help-block with-errors is-invalid"></div>
                    </div>
                </div>
            ...
            @if($collectionType)
                <div class="form-row form-group align-items-center">
                    ...
                    <div class="col-lg-5">
                        <div class="input-group">
                            <input type="text" class="form-control textNumber" name="principalAmount" id="principalAmount" value="{{ $principalAmount }}" required data-error="Please give Amount">
                        </div>
                        <div class="help-block with-errors is-invalid"></div>
                    </div>
                </div>
                ...
                <div class="form-row form-group align-items-center">
                    ...
                    <div class="col-lg-5">
                        <div class="input-group">
                            <input type="text" class="form-control textNumber" name="interestAmount" id="interestAmount" value="{{ $interestAmount }}"
            ...
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        ...
                        value="{{ $amount }}" required data-error="Please give Amount" @if($collectionType) {{ 'readonly' }} @endif>
                    </div>
                    <div class="help-block with-errors is-invalid"></div>
                </div>
            </div>
