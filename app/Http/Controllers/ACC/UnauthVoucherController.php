...
class UnauthVoucherController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            // $QueryData = Voucher::where('is_delete', '=', 0)->where('voucher_status', '=', 0)->where('v_generate_type', '=', 0)
            ...
            $QueryData = Voucher::from('acc_voucher as av')
                ...
                ->where('av.voucher_status', '=', 0)
                ->where('av.v_generate_type', '=', 0)
            ...
            $vdata = Voucher::where('is_delete', '=', 0)->where('voucher_status', '=', 0)->where('v_generate_type', '=', 0)
                ->whereIn('branch_id', HRS::getUserAccesableBranchIds())->get();

            return view('ACC.UnauthVoucher.index', compact('vdata'));
        }
    }
