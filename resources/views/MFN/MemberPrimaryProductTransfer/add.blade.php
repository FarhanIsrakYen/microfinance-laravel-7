...
<form enctype="multipart/form-data" method="post" class="form-horizontal"
    ...
    <div class="row">
        ...
        <!-- Left Input Field -->
        <div class="col-lg-6">
            <input id="oldProductId" type="hidden" class="form-control round" name="oldProductId">
            <div class="form-row form-group align-items-center">
                <label class="col-lg-4 input-title RequiredStar">Member</label>
                <div class="col-lg-7">
                    <div class="input-group">
                        <select class="form-control clsSelect2" name="memberId"
                        id="member_id" required data-error="Please Select Member">
    ...
    $( document ).ready(function() {
        ...
        $("#member_id").change(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "./getData",
                data: {context : 'product', member_id : member_id},
                dataType: "json",
                success: function (response) {
                    ...
                    $('.infoCurrentProductName').html(response.memberdata.LoanProduct);
