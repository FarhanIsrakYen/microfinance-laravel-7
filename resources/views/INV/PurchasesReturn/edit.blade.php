...
<form method="post" data-toggle="validator"
    ...
    <div class="panel">
        ...
        <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="input-group">
                            <input type="text" name="bill_no" id="bill_no" class="form-control round"
                                value="{{$PReturnData->bill_no}}" required readonly>
                        </div>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="form-row form-group align-items-center">
                    <label class="col-lg-4 input-title RequiredStar">Return Date</label>
                    <div class="col-lg-7 input-group">
                        ...
                        foreach($PReturnDataD as $RowD){
                            ...
                            <tr>
                                ...
                                <td width="35%">
                                    ...
                                    <input type="hidden" name="product_code_arr[]" id="product_code__{{ $i }}"
                ...
                <table class="table table-striped table-bordered w-full text-center" id="tableQuanAmnt">
                    <tbody>
                        <tr>
                            ...
                            <td width="10%" id="tdTotalQuantity" class="text-center" style="font-weight: bold;">0</td>
