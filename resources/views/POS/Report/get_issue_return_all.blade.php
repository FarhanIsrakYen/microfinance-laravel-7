...
$issueData = Common::ViewTableOrder('pos_issues_r_d',
    [['is_delete', 0], ['is_active', 1]],
    ['id', 'ir_bill_no'],
    ['ir_bill_no', 'ASC']);
        ...
        <div class="panel-body">
            <div class="row align-items-center pb-10 d-print-none">
                ...
                <div class="col-lg-2">
                    ...
                    <div class="input-group">
                        <select class="form-control clsSelect2" name="ir_bill_no" id="ir_bill_no">
                            <option value="">Select All</option>
                            @foreach ($issueData as $row)
                            <option value="{{ $row->ir_bill_no }}">{{ $row->ir_bill_no}}</option>
                            @endforeach
                ...
                <div class="table-responsive">
                    <table class="table w-full table-hover table-bordered table-striped clsDataTable">
                        <thead>
                            <tr>
                                <th width="3%">#</th>
                                <th class="text-center">Issue Return Date</th>
...
function ajaxDataLoad(start_date = null, end_date = null, branch_id = null, product_id = null,
    ir_bill_no = null, group_id = null, cat_id = null, sub_cat_id = null, brand_id = null) {
...
$(document).ready(function() {
    ...
    $('#searchButton').click(function() {
        ...
        ajaxDataLoad(start_date, end_date, branch_id, product_id, ir_bill_no,
