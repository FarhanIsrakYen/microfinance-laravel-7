            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="form-group">
                        ...
                        <div class="input-group ">
                            <input type="text" value="{{$PSubCategoryData->sub_cat_name}}" class="form-control round"
                                id="sub_cat_name" name="sub_cat_name" placeholder="Enter Group Name" required
                                data-error="Please select Sub category name.">
                        </div>
                        <div class="help-block with-errors is-invalid"></div>
                    </div>
                </div>
