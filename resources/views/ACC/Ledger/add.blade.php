        ...
        <div class="col-lg-12 offset-lg-3">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <div class="input-group">
                            <input type="text" class="form-control round" name="name" id="name" placeholder="Enter Ledger Name">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-4 form-group">
                    <div class="input-group">
                        <select class="form-control clsSelect2" name="parent_id" id="parent_id" onchange="fnAjaxSelectBox(
                                                'order_by',
                                                this.value,
                            ...
                            @if(isset($LedgerData))
                                    <option value="{{$LedgerData->id}}" selected >{{$LedgerData->name}}</option>
                            @else
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <div class="checkbox-custom checkbox-primary">
                            ...
                            <input type="checkbox" id="project_array_0" name="project_array[]" checked value='0' />
                            ...
                            <div class="checkbox-custom checkbox-primary">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <input type="checkbox" class="project_cls" id="project_array_{{$Row->id}}" name="project_array[]" checked value="{{$Row->id}}" />
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <div class="checkbox-custom checkbox-primary">
                            <input type="checkbox" name="is_group_head" checked />
                            <label></label>
                        </div>
                    </div>
                </div>
