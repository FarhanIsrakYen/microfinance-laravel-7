...
class PurchaseController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $totalData = PurchaseMaster::where([['is_delete', '=', 0]])
            ...
            foreach ($PurchaseData as $Row) {
                ...
                if (date('d-m-Y', strtotime($Row->purchase_date)) != Common::systemCurrentDate($Row->branch_id,'inv')) {
            ...
            return view('INV.Purchases.index');
        }
    }
    ...
    public function add(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            try {
                ...
                return Redirect::to('inv/purchase')->with($notification);
            } catch (\Exception $e) {
                dd($e);
                DB::rollBack();
            ...
            $SupplierData = Supplier::where(['is_delete' => 0, 'is_active' => 1])
                ...
                ->get();
            return view('INV.Purchases.add', compact('SupplierData'));
        }
    }
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $SupplierData = Supplier::where('is_delete', 0)
                ->whereIn('branch_id', HRS::getUserAccesableBranchIds())
                ->orderBy('id', 'DESC')->get();
            return view('INV.Purchases.edit', compact('PurchaseData', 'PurchaseDataD', 'SupplierData'));
        }
    }
    ...
    public function view($id = null)
    {
        ...
        return view('INV.Purchases.view', compact('PurchaseData', 'PurchaseDataD', 'Supplier'));
    }
