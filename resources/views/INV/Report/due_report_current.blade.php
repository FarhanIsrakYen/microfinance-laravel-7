        ...
        <div class="panel-body">
            ...
            <div class="row text-dark ExportHeading">
                <div class="col-xl-12 col-lg-12 col-sm-12 col-md-12 col-12" style="text-align:center;">
                    ...
                    <span>Due Register Report(Current Due)</span><br>
                    (To 
            ...
            <div class="row d-print-none text-right">
                <div class="col-lg-12">
                    ...
                    <a href="javascript:void(0)" title="Excel" style="background-color:transparent;border:none;"
                        onclick="fnDownloadExcel('ExportHeading,ExportDiv', 'Current_Due_Report_{{ (new Datetime())->format('d-m-Y') }}');">
...
<script>
    ...
    function ajaxDataLoad(end_date = null, branch_id = null) {
        ...
        $('.clsDataTable').DataTable({
            ...
            searching: false,
            "ajax": {
                "url": "{{ url('inv/report/current_due') }}",
                "dataType": "json",
                "type": "post",
                "data": {
                    endDate: end_date,
            ...
            drawCallback: function(oResult) {
                ...
                if (oResult.json) {
                    ...
                    $('#pAmt').html(oResult.json.ttl_paid_amt);
