                ...
                <tbody class="scrollBody">
                    ...
                    <tr>
                        <td width="61%" class="input-group barcodeWidth">
                            ...
                            <input type="hidden" id="stock_quantity_{{ $i }}" value="{{(int)INVS::stockQuantity($Data->branch_from,$Data->product_id ) + $Data->product_quantity}}">
    ...
    var BranchId = $('#branch_from').val();
        ...
        if(BranchId == 1){
                swal({
                    ...
                    if (isConfirm) {
                        window.location.href = "{{url('inv/issue_return')}}";
                    }
                });
