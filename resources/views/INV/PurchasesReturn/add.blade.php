                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7">
                            <div class="input-group">
                                ...
                                value="{{ POSS::generateBillPurchaseReturn(Common::getBranchId()) }}" required readonly>
                            </div>
                        </div>
                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7 input-group">
                            <select class="form-control clsSelect2"
                                ...
                                @foreach(Common::ViewTableOrderIn('inv_suppliers', ['is_delete'=>0], ['branch_id', HRS::getUserAccesableBranchIds()], ['id','sup_name'], ['sup_name','ASC']) as $rowSup)
        ...
        <div class="panel-body">
            ...
            <table class="table table-hover table-striped table-bordered w-full text-center table-responsive" id="purchaseTable">
                ...
                <tbody class="scrollBody">
                    ...
                    <tr>
                        <td width="61%" class="input-group text-left">
                            <!-- {{-- name="product_id_arr[]" --}} -->
