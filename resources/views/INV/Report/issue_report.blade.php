...
$issueData = Common::ViewTableOrder('inv_issues_m',
    [['is_delete', 0], ['is_active', 1]],
    ['id', 'bill_no'],
    ['bill_no', 'ASC']);
            ...
            <div class="row d-print-none text-right">
                <div class="col-lg-12">
                    ...
                    <a href="javascript:void(0)" title="Excel" style="background-color:transparent;border:none;"
                        onclick="fnDownloadExcel('ExportHeading,ExportDiv', 'Issue_Report_{{ (new Datetime())->format('d-m-Y') }}');">
...
function ajaxDataLoad(start_date = null, end_date = null, branch_id = null, product_id = null,
    ...
    $('.clsDataTable').DataTable({
        ...
        searching: false,
        "ajax": {
            "url": "{{ route('INVissueDataTableReport') }}",
            "dataType": "json",
            "type": "post",
            "data": {
                _token: "{{ csrf_token() }}",
