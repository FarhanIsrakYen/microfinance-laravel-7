    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="input-group">
                        <select class="form-control clsSelect2" name="newSamityId"
                        id="newSamityId" required data-error="Please Select Primary Product">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            value="{{ \Carbon\Carbon::parse($TransferData->date)->format('d-m-Y') }}" readonly>
                        </div>
                        <div class="help-block with-errors is-invalid"></div>
                    </div>
                </div>
