    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-3">
            ...
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="input-group">
                        <input type="text" class="form-control round textNumber" placeholder="Enter Deposit Amount" 
                        name="cumulativeDeposit" id="cumulativeDeposit" value="0">
                    </div>
                </div>
            </div>
            ...
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="input-group">
                        ...
                        name="cumulativeInterest" id="cumulativeInterest" value="0">
                    </div>
                </div>
            </div>
            ...
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="input-group">
                        ...
                        name="cumulativeWithdraw" id="cumulativeWithdraw" value="0">
                    </div>
                </div>
            </div>
            ...
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="input-group">
                        ...
                        name="closingBalance" id="closingBalance" value="0" readonly>
                    </div>
                </div>
            </div>
