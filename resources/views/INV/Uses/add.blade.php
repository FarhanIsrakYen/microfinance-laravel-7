            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7 input-group">
                            <input type="text" name="uses_bill_no" id="uses_bill_no_f" class="form-control round" 
                                value="{{ INVS::generateBillSales(Common::getBranchId()) }}" readonly>
                            <!-- <span id="uses_bill_no" class="text-black">
                                {{ INVS::generateBillSales(Common::getBranchId()) }} -->
                            </span>
                        </div>
                    </div>

                    <div class="form-row form-group align-items-center">
                        <label class="col-lg-4 input-title">Use Date</label>
                        <div class="col-lg-7 input-group">
                            <input type="text" name="uses_date" id="uses_date_f" class="form-control round" 
                                value="{{ Common::systemCurrentDate() }}" readonly>
                            <!-- <span id="uses_date" class="text-black">
                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7 input-group">
                            ...
                            <select class="form-control clsSelect2" name="requisition_no" id="requisition_no" style="width: 100%">

                                <option value="">Select Requisition</option>
                                @foreach($RequsitionList as $Row)
                                <option value="{{ $Row->requisition_no }}">
                                    {{ $Row->requisition_no }}
                                </option>
                                @endforeach
                            </select>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="form-row form-group align-items-center">
                            <label class="col-lg-4 input-title RequiredStar">Use For</label>
                            <div class="col-lg-7">
                        ...
                        <div class="form-row form-group align-items-center" id="empDiv" style="display: none;">
                            <label class="col-lg-4 input-title RequiredStar">Employee</label>
                            <div class="col-lg-7 input-group">
                                ...
                                <select class="form-control clsSelect2" name="employee_no" id="employee_no" style="width: 100%">
                            ...
                            <div class="col-lg-7">
                                <div class="input-group">
                                    <?php $roomList = Common::ViewTableOrder('hr_rooms',
                                                ...
                                                ['room_name', 'ASC']) ?>
                                    <select class="form-control clsSelect2" name="room_id" id="room_id" style="width: 100%;">
        ...
        <div class="panel-body">
            ...
            <table class="table table-hover table-striped table-bordered w-full text-center table-responsive"
                ...
                <thead class="scrollHead">
                    <tr>
                        <th width="66%" class="RequiredStar">Product Name</th>
            ...
            <div class="row align-items-center pt-20">
                <div class="col-lg-12">
                    <div class="d-flex justify-content-center">
                        ...
                        <button type="submit" name="submitButtonforPurchase"
                            class="btn btn-primary btn-round ml-2" id="submitButtonforUses">Save</button>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    // $(document).ready(function() {
        ...
        $('#department_id').change(function() {
            $.ajax({
                method: "GET",
                url: "{{url('inv/use/ajReqLoadDeptWise')}}",
                dataType: "text",
                data: {
    ...
    $('#submitButtonforUses').on('click', function(event) {
