            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-row form-group align-items-center">
                        <label class="col-lg-4 input-title">Transfer No</label>
                        <div class="col-lg-7">
                            <div class="input-group">
                                <input type="text" name="bill_no" id="bill_no" class="form-control round"
                                    value="{{$TransferData->bill_no}}" readonly>
                            </div>
                        </div>
        ...
        <div class="panel-body">
            ...
            <table class="table table-hover table-striped table-bordered w-full text-center table-responsive" id="transferTable">
                ...
                <tbody class="scrollBody">
                    ...
                    ?>
                    <tr>
                        <td width="50%" class="barcodeWidth onlyNumber">
                            {{-- name="product_id_arr[]" --}}
                    ...
                    @if(count($TransferDataD) > 0)
                        ...
                        <tr>
                            <td width="50%" class="barcodeWidth">
                                ...
                                <input type="hidden" id="stock_quantity_{{ $i }}" value="{{POSS::stockQuantity($TransferData->branch_from,$TranData->product_id) + $TranData->product_quantity}}">
                            ...
                            <td width="15%">
                                <input type="number" name="unit_cost_price_arr[]" id="unit_cost_price_{{ $i }}"
                                    class="form-control round text-right" value="{{ $TranData->unit_cost_price }}" required
                                    min="1" readonly>
                            </td>
                            ...
                            <td width="16%">
                                <input type="number" name="total_cost_price_arr[]" id="total_cost_price_{{ $i }}"
                                    ...
                                    value="{{ $TranData->total_cost_price }}" min="1" readonly>
                            </td>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function fnBranchDate(BranchId) {
            if (BranchId != '') {
                $.ajax({
                    method: "GET",
                    url: "{{ url('/ajaxBranchDate') }}",
                    dataType: "text",
                    data: {
                        BranchId: BranchId,
                        Module: 'pos'
                    ...
                    success: function(data) {
                        if (data) {
                            $('#transfer_date_h').val(data);
                            $('#transfer_date').val(data);
                        }
                    }
                });
            }
        ...
        if (branchFrom != 1 ) {
            if (branchTo != 1) {
                ...
                swal({
                  ...
                  if (isConfirm) {
                    window.location.href = "{{url('pos/transfer')}}";
                  }
                });
            }
