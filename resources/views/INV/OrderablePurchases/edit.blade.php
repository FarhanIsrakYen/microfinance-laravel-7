...
<form method="post" data-toggle="validator" novalidate="true" id="purchase_form">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="col-lg-7 form-group">
                            <div class="input-group">
                                <input type="text" name="bill_no" id="bill_no" class="form-control round"
                                    value="{{ $PurchaseData->bill_no }}" required readonly>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="row align-items-center">
                            <div class="col-lg-4">
                                <label class="input-title RequiredStar">Supplier</label>
                            </div>
                            <div class="col-lg-7 input-group">

                                <select class="form-control clsSelect2"
                                     name="supplier_id" id="supplier_id"
                                    onchange="fnSupplierNameLoad(); fnProductLoad();" required disabled>

                                    <option value="">Select Supplier</option>
                                    @foreach($SupplierData as $SData)
                                    <option value="{{ $SData->id }}" @if($SData->id == $PurchaseData->supplier_id) selected @endif>
                                        {{ $SData->sup_name }}</option>
                                    @endforeach
                                </select>
                                <div class="help-block with-errors is-invalid"></div>
                            </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <div class="row align-items-center">
                            <?php
                                $orders = App\Model\INV\OrderMaster::where([['is_approve', 1], ['is_delivered', 0], ['is_active', 1], ['is_delete', 0]])->get();
                            ?>
                            <div class="col-lg-4">
                                <label for="textOrderNumber" class="input-title RequiredStar">Order No</label>
                            </div>
                            <div class="col-lg-7">
                                <select class="form-control clsSelect2" name="order_no" required
                                id="order_no" disabled>
    ...
    <div class="panel">
        <div class="panel-body">
            ...
            <table  class="table table-hover table-striped table-bordered w-full text-center table-responsive mt-4" id="purchaseTable">
                ...
                <tbody class="scrollBody">
                    ...
                    @if(count($PurchaseDataD) > 0)
                        ...
                        <?php $i++; ?>
                        <tr>
                            <td class="input-group barcodeWidth text-left">
                            ...
                            <td>
                                <input type="number" name="unit_cost_price_arr[]" id="unit_cost_price_{{ $i }}"
                                    class="form-control round text-right" value="{{ $PurData->unit_cost_price }}" required
                                    min="1" readonly>
                            </td>
