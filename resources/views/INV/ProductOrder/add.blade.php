        ...
        <div class="col-lg-6">
                ...
                <div class="col-lg-5">
                    <div class="form-group">
                        <div class="input-group ">
                            <input type="text" class="form-control round" id="order_no" name="order_no" placeholder="Requisition No" value="{{ INVS::generateBillOrder(Common::getBranchId()) }}" required="required" readonly>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="form-group">
                        <div class="input-group ">
                            <input type="text" name="order_date" id="order_date" class="form-control round" value="{{ Common::systemCurrentDate() }}" placeholder="DD-MM-YYYY" readonly="true" required>
                        </div>
                    </div>
                </div>
            </div>
    ...
    if ($('#product_id_0').val() != '' && $('#product_quantity_0').val() > 0) {
        ...
        if (flag === true) {
            ...
            html += '<td width="61%">' +
                ...
                '<input type="text" class="form-control round" value="' + ProductName  +  ( ProductBarcode ? '(' + ProductBarcode  + ')' : '') +
                '" readonly >' +
                '</td>';
