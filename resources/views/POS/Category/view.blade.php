            ...
            <div class="col-lg-5">
                <div class="form-group">
                    <div class="input-group ">
                        <select class="form-control clsSelect2" readonly required data-error="Please select group name."
                            name="prod_group_id" id="prod_group_id" disabled>
                            <option value="{{$PCategoryData->prod_group_id}}">
                                {{$PCategoryData->pgroup->group_name}}</option>
                        </select>
                    </div>
