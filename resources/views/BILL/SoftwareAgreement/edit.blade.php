...
<!-- Page -->
<form method="post" data-toggle="validator" novalidate="true" id="agreement_form">
    @csrf
    <div class="panel">
                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7">
                            <select class="form-control clsSelect2" name="customer_id" id="customer_id" 
                                ...
                                <option value="{{ $cData->id }}" {{ $cData->id == $agreementData->customer_id ? 'selected' : '' }}>{{ $cData->customer_name. ' - ' . $cData->customer_no }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-row form-group align-items-center">
                        ...
                        <div class="col-lg-7">
                            <div class="input-group">
                                ...
                                <input type="text" name="agreement_end_date" id="agreement_end_date" class="form-control round" value="{{ $agreementData->agreement_end_date }}" readonly>
                            </div>
                        </div>
                    </div>
    ...
    <div class="panel">
        <div class="panel-body">
            ...
            <table class="table table-hover table-striped table-bordered w-full text-center table-responsive my-custom-scrollbar"
                ...
                <thead>
                    <tr>
                        <th width="15%" class="" rowspan="2">Product/Package</th>
                ...
                // 'company_id'=> $CompanyID,
                    ...
                    @if(count($agreementDataD) > 0)
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- {{-- name="product_quantity_arr[]"  --}} -->
                                <input type="number" name="product_quantity_arr[]" id="product_quantity_{{ $i }}" class="form-control round licenseFeeClass text-right" value="{{ $agreement->product_quantity }}">
                            </td>
                            <td>
                                <!-- {{-- name="branch_no_arr[]"  --}} -->
                                <input type="number" name="branch_no_arr[]" id="branch_no_{{ $i }}" class="form-control round licenseFeeClass text-right" onkeyup="fnTtlProductPrice({{ $i }});" value="{{ $agreement->branch_no }}" required>
                            </td>

                            <td>
                                <!-- {{-- name="service_start_date_arr[]"  --}} -->
                                <input type="text" name="service_start_date_arr[]" id="service_start_date_{{ $i }}" class="form-control round datepicker-custom" placeholder="DD-MM-YYYY" required
                                value="{{ (new DateTime($agreement->service_start_date))->format('d-m-Y') }}">
                            </td>

                            <td>
                                <input type="number" name="license_fee_ho_arr[]" id="license_fee_ho_{{ $i }}"
                                    class="form-control round clsQuantity text-right" placeholder="Enter License Fee"
                                    value="{{ $agreement->license_fee_ho }}" onkeyup="fnTtlProductPrice({{ $i }});">
                            </td>

                            <td>
                                <input type="number" name="license_fee_br_arr[]" id="license_fee_br_{{ $i }}"
                                    class="form-control round clsQuantity text-right" placeholder="Enter License Fee"
                                    value="{{ $agreement->license_fee_br }}"
                            ...
                            <td>
                                <input type="number" name="license_fee_arr[]" id="license_fee_{{ $i }}"
                                    class="form-control round clsQuantity text-right" placeholder="Enter License Fee"
                                    value="{{ $agreement->license_fee }}" min="1" readonly>
                            </td>

                            <td>
                                <input type="number" name="service_fee_ho_arr[]" id="service_fee_ho_{{ $i }}"
                                    class="form-control round text-right" value="{{ $agreement->service_fee_ho }}" 
                                    onkeyup="fnTtlProductPrice({{ $i }});">
                            </td>

                            <td>
                                <input type="number" name="service_fee_br_arr[]" id="service_fee_br_{{ $i }}"
                                    class="form-control round text-right" value="{{ $agreement->service_fee_br }}" 
                                    onkeyup="fnTtlProductPrice({{ $i }});">
                            ...
                            <td>
                                <input type="number" name="service_fee_arr[]" id="service_fee_{{ $i }}"
                                    class="form-control round text-right" value="{{ $agreement->service_fee }}"
                                    min="1" readonly>
                    ...
                    <tbody>
                        <tr>
                            <td width="25%">
                                ...
                                <input type="hidden" name="total_license_fee" id="total_license_fee" value="{{ $agreementData->total_license_fee }}"
                                    min="1">
                            </td>
                            <td width="20%" id="tdTotalLicense" class="text-right" style="font-weight: bold;">{{ $agreementData->total_license_fee }}</td>

                            <td width="20%">
                                <h5>Total Service Fee</h5>
                                <input type="hidden" name="total_service_fee" id="total_service_fee" value="{{ $agreementData->total_service_fee }}" min="1">
                            </td>
                            <td width="5%" id="tdTotalService" class="text-right" style="font-weight: bold;">{{ $agreementData->total_service_fee }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<script type="text/javascript">
    ...
    //     var totalProductPrice = $('#total_amount').val();
    //     var ttlLicenseFee = 0;
    //     var ttlServiceFee = 0;
    ...
    //         totalProductPrice = Number(ttlLicenseFee) + Number(ttlServiceFee);
    ...
    function fnTtlProductPrice(Row) {
        ...
        var i;
        for (i = 0; i <= ttlRow; ++i) {
            var noOfBranch = $('#branch_no_' + i).val();
            var licenseFeeHO = $('#license_fee_ho_' + i).val();
            var licenseFeeBR = $('#license_fee_br_' + i).val();
