    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-3">
            ...
            <div class="form-row form-group align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        ...
                        placeholder="Enter Notice Title" required data-error="Please Enter Notice Title">{{ $noticeData->name }}</textarea> 
                    </div>
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        ...
                        id="active_till" required data-error="Please Select Status">
                            <option value="1" @if($noticeData->noticePeriod == '0000-00-00 00:00:00') selected @endif>Infinity</option>
                            <option value="2" @if($noticeData->noticePeriod >= $systemTime) selected @endif>Set Time</option>
                        </select>
                    </div>
                    <div class="help-block with-errors is-invalid"></div>
                </div>
            ...
            <div class="form-row form-group align-items-center" style="display: none" id="periodDiv">
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                        <input id="noticePeriod" type="text" class="form-control round" name="noticePeriod" value="{{ $noticeData->noticePeriod }}">
                    </div>
                </div>
            </div>
