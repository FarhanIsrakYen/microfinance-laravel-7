...
<div class="row align-items-center pb-5 mb-4">
    ...
    <div class="col-lg-2">
        ...
        <div class="input-group">
            <select class="form-control clsSelect2" name="filStatus" id="filStatus">
                <option value="">All</option>
    ...
    <div class="col-lg-2">
        ...
        <div class="input-group">
            <input type="text" class="form-control" id="name_or_code" name="name_or_code" placeholder="Member Name/Code"
...
<script>
    function ajaxDataLoad(branch_id = null, samity_id = null, filStatus = null, name_or_code = null, start_date = null, end_date = null) {
    ...
    $(document).ready(function () {
        ...
        $('#searchButton').click(function () {
            ...
            ajaxDataLoad(branch_id, samity_id, filStatus, name_or_code, start_date, end_date);
        });
