...
<div>
    ...
    <div class="row align-items-center pb-10 d-print-none">
        ...
        <div class="col-lg-4 pt-25 text-center">
            <a href="javascript:void(0);" id="btnSearch" class="btn btn-primary btn-round mr-2">Search</a>
...
<script>
    ...
    function fnDelete(RowID) {
        $.ajax({
            method: "GET",
            url: "{{url('pos/day_end/ajaxDeleteDayEnd')}}",
            dataType: "text",
            data: {
                RowID: RowID,
            },
