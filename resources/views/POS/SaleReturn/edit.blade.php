...
<form method="POST" data-toggle="validator" novalidate="true" id="sale_ret_form" autocomplete="off">
    ...
    <div class="row">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="form-row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <!-- <select name="sales_bill_no" id="sales_bill_no" class="form-control round clsProductSelect" 
                                    required data-error="Please enter Sales Bill No.">
                                    <option value="{{ $SaleRM->sales_bill_no }}">{{ $SaleRM->sales_bill_no }}
                                    </option>
                                </select> -->
                                <input type="hidden" name="sales_bill_no" id="sales_bill_no" class="form-control round"
                                value="{{ $SaleRM->sales_bill_no }}">
                                <label class="text-black">{{ $SaleRM->sales_bill_no }}</label>
                            </div>
                    ...
                    <!-- {{-- <input type="hidden"  name="sales_date" id="sales_date" > --}} -->
                    ...
                    <div class="form-group" style="margin-bottom: 0.7rem">
                        <div class="form-row align-items-center">
                            <div class="col-lg-4">
                                <label class="input-title">Sales Date</label>
                            </div>
                            <div class="col-lg-7">
                                <input type="hidden" class="form-control round" name="sales_date" id="sales_date"
                                    value="{{ $SaleRM->sales_date }}" readonly>
                                <label id="sales_date_copy" class="text-black">{{ $SaleRM->sales_date }}</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group" style="margin-bottom: 0.7rem">
                        <div class="form-row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <input type="hidden" class="form-control round text-right" name="sales_paid_amount"
                                    id="sales_paid_amount" value="{{ $SaleRM->sales_paid_amount }}" readonly>
                                <label id="sales_paid_amount_copy" class="text-black">{{ $SaleRM->sales_paid_amount }}</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <input type="hidden" class="form-control round text-right" name="sales_due_amount"
                                    id="sales_due_amount" value="{{ $SaleRM->sales_due_amount }}" readonly>
                                <label id="sales_due_amount_copy" class="text-black">{{ $SaleRM->sales_due_amount }}</label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-7">
            <div class="panel">
                <div class="panel-body">
                    <h5 class="text-center">Sales Return Information</h4>
                    <br>
                    ...
                    <div class="form-group">
                        <div class="form-row align-items-center">
                            <div class="col-lg-4">
                                <label for="SalesReturnInfo" class="input-title">Sales Return Bill NO</label>
                            </div>
                            <div class="col-lg-7">
                            ...
                            <table class="table table-hover table-striped table-bordered w-full text-center" id="salesReturnTable">
                                ...
                                <tbody class="scrollBody">
                                    ...
                                    <tr>
                                        ...
                                        <td width="16%">
                                            <input type="number" id="total_sales_price_0"
                                                class="form-control round ttlAmountCls text-right" value="0" min="1"
                                                readonly>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="15%">
                                            <input type="hidden" name="product_barcode_arr[]"
                                                id="product_barcode_{{ $i }}" value="{{ $Data->product_barcode }}">

                                            <input type="hidden" id="stock_quantity_0" value="0">

                                            <input type="hidden" name="product_system_barcode_arr[]"
                                                id="product_system_barcode_{{ $i }}"
                                        ...
                                        <td width="15%">
                                            <input type="number" name="product_sales_price_arr[]"
                                                id="product_sales_price_{{ $i }}" class="form-control round text-right"
                                                value="{{ $Data->product_sales_price }}" required min="1" readonly>
                                        </td>

                                        <td width="16%">
                                            <input type="number" name="total_sales_price_arr[]"
                                                id="total_sales_price_{{ $i }}"
                                                class="form-control round ttlAmountCls text-right"
                                                value="{{ $Data->total_amount }}" min="1" readonly>
                                        </td>
                    ...
                    <!-- <div class="form-group">
                        <div class="form-row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <input type="text" class="form-control round text-center" name="total_return_quantity"
                                    id="total_return_quantity" readonly>
                            </div>
                        </div>
                    </div> -->
...
<!-- 
                    ...
                    <!-- <div class="form-group">
                        <div class="form-row align-items-center">
                            <div class="col-lg-4">
                                <label for="total_return_amount" class="input-title">Return Description</label>
                            </div>
                            <div class="col-lg-7">
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data) {
                    ...
                    $( "#tbodydetails tr td:nth-child(2)" ).css("text-align", "center");
