...
use App\Model\INV\PSubCategory;
...
class PSubCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('INV.SubCategory.index', compact('PSubCategoryData'));
    }
    ...
    public function add(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($isInsert) {
                ...
                return Redirect::to('inv/subcategory')->with($notification);
            } else {
                $notification = array(
            ...
            return view('INV.SubCategory.add', compact('PgroupData'));
        }
    }
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return view('INV.SubCategory.edit', compact('PSubCategoryData', 'PgroupData'));
    ...
    public function view($id = null)
    {
        ...
        return view('INV.SubCategory.view', compact('PGroupData'));
