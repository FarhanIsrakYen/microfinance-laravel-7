...
//                'company_id' => 'required',
            ...
            if ($isInsert) {
                ...
                return Redirect::to('hr/fiscal_year')->with($notification);
            } else {
                $notification = array(
...
//                'company_id' => 'required',
            ...
            return view('HR.FiscalYear.edit', compact('FiscalYear'));
        }
    }
    ...
    {
        $FiscalYear = FiscalYear::where('id', $id)->first();
        return view('HR.FiscalYear.view', compact('FiscalYear'));
    }
