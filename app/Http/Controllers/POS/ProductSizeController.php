...
class ProductSizeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('POS.ProductSize.index', compact('ProdSizeData'));
    }
    ...
    public function add(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($isInsert) {
                ...
                return Redirect::to('pos/size')->with($notification);
            } else {
                $notification = array(
            ...
            return view('POS.ProductSize.add', compact('ProdGroupData'));
        }
    }
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return view('POS.ProductSize.edit', compact('ProdSizeData','ProdGroupData'));
        }
    }
    ...
    {
        $ProdSizeData = PSize::where('id', $id)->first();
        return view('POS.ProductSize.view', compact('ProdSizeData'));
    }
