...
class OrderController extends Controller
{
            ...
            foreach ($order_check_box_arr as $value) 
            {
            	if (!empty($value)) 
            	{
		            ...
		            try 
		            {
		                ...
		                $reqUpdate = DB::table('pos_requisitions_m as prm')
                            ->where('requisition_no', $requestData['requisition_no'])
                            ->select('prm.id', 'product_quantity')
                            ->leftjoin('pos_requisitions_d as prd', function($reqUpdate) use($prod_id){
    ...
    public function view($id = null)
    {
        ...
        $requistionData = DB::table('pos_orders_d as pod')
            ...
            ->leftjoin('pos_orders_m as pom', function($requistionData){
